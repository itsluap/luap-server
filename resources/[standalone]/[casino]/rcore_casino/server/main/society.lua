-- choose between 'framework', 'okokbanking', '710-Management'
local managementFramework = "framework"
...
function RemoveMoneyFromSociety(money)
    if managementFramework == "okokbanking" then
        ...
        return
    elseif managementFramework == "710-Management" then
