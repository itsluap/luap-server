            ...
            Framework.Functions.TriggerCallback(
                ...
                function(canSit)
                    if canSit then
                        ...
                        Framework.Functions.Notify(_U('chair_occupied'))
                    end
                end,
                self.index,
                chairId
                    ...
                    while clientTimer ~= nil do
                        ...
                        if clientTimer ~= nil then
                            ...
                            if clientTimer < 1 then
                                clientTimer = nil
                                Framework.Functions.Notify(_U('no_react'))
            ...
            Citizen.CreateThread(
                function()
                    while activePokerTable do
                        ...
                        if playerBetted and Framework then
                            local reactiveText = ''
                            ...
                            if self.TimeLeft == nil or self.TimeLeft > 0 then
                                ...
                                if IsDisabledControlJustPressed(0, 176) then
                                    if currentBetInput > 0 then
                                        ...
                                        Framework.Functions.Notify(_U('no_bet_input'))
                                    end
                                end
                        ...
                        DrawAdvancedNativeText(0.965, 0.849, 0.005, 0.0028, 0.29, _U('table_min_max'), 255, 255, 255, 255, 0, 0)
                        ...
                        DrawAdvancedNativeText(0.965, 0.892, 0.005, 0.0028, 0.29, _U('current_player_chips'), 255, 255, 255, 255, 0, 0)
                        ...
                        DrawAdvancedNativeText(0.965, 0.935, 0.005, 0.0028, 0.29, _U('current_bet_input'), 255, 255, 255, 255, 0, 0)
...
Citizen.CreateThread(
    function()
        while true do
            ...
            if Framework and not InformationPlaying and activePokerTable == nil and activeChairData == nil then
