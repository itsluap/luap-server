...
RegisterNetEvent("luap-scoreboard:RemovePlayer")
AddEventHandler("luap-scoreboard:RemovePlayer", function(data)
    ST.Scoreboard:RemovePlayer(data)
end)

RegisterNetEvent("luap-scoreboard:AddPlayer")
AddEventHandler("luap-scoreboard:AddPlayer", function(data)
    ST.Scoreboard:AddPlayer(data)
end)

RegisterNetEvent("luap-scoreboard:RemoveRecent")
AddEventHandler("luap-scoreboard:RemoveRecent", function(src)
    ST.Scoreboard:RemoveRecent(src)
end)

RegisterNetEvent("luap-scoreboard:AddAllPlayers")
AddEventHandler("luap-scoreboard:AddAllPlayers", function(data, recentData)
