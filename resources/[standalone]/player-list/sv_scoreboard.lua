...
RegisterServerEvent('luap-scoreboard:AddPlayer')
AddEventHandler("luap-scoreboard:AddPlayer", function()
    ...
    TriggerClientEvent("luap-scoreboard:AddPlayer", -1, data )
...
function ST.Scoreboard.AddAllPlayers(self)
    ...
    for i=1, #xPlayers, 1 do
        ...
        TriggerClientEvent("luap-scoreboard:AddAllPlayers", source, data, recentData)
...
AddEventHandler("playerDropped", function()
    ...
    TriggerClientEvent("luap-scoreboard:RemovePlayer", -1, data )
    Wait(600000)
    TriggerClientEvent("luap-scoreboard:RemoveRecent", -1, plyid)
end)
