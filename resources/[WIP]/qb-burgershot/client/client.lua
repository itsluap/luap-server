...
AddEventHandler('qb-burgershot:client:open:box', function(BoxId)
    TriggerServerEvent("inventory:server:OpenInventory", "stash", 'burgerbox_'..BoxId, {maxweight = 5000, slots = 6})
    TriggerEvent("inventory:client:SetCurrentStash", 'burgerbox_'..BoxId)
end)

RegisterNetEvent('qb-burgershot:client:open:cold:storage')
AddEventHandler('qb-burgershot:client:open:cold:storage', function()
    TriggerServerEvent("inventory:server:OpenInventory", "stash", "burger_storage", {maxweight = 1000000, slots = 10})
    TriggerEvent("inventory:client:SetCurrentStash", "burger_storage")
end)

RegisterNetEvent('qb-burgershot:client:open:hot:storage')
AddEventHandler('qb-burgershot:client:open:hot:storage', function()
    TriggerServerEvent("inventory:server:OpenInventory", "stash", "heattray", {maxweight = 1000000, slots = 10})
    TriggerEvent("inventory:client:SetCurrentStash", "warmtebak")
end)

RegisterNetEvent('qb-burgershot:client:open:tray')
AddEventHandler('qb-burgershot:client:open:tray', function(Number)
    TriggerServerEvent("inventory:server:OpenInventory", "stash", "foodtray"..Number, {maxweight = 100000, slots = 3})
    TriggerEvent("inventory:client:SetCurrentStash", "foodtray"..Number)
end)
...
-- qb-target exports --
exports['qb-target']:AddBoxZone("BurgershotBoard", vector3(-1191.27, -900.43, 13.98), 1, 1, {
