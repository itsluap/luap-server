...
RegisterNetEvent("indigo-sit:Sit", function(data)
	local playerPed = PlayerPedId()
...
function wakeup()
	...
	TriggerServerEvent('indigo-sit:leavePlace', currentSitCoords)
...
function sit(object, modelName, data)
	...
	QBCore.Functions.TriggerCallback('indigo-sit:getPlace', function(occupied)
		if occupied then
			...
			TriggerServerEvent('indigo-sit:takePlace', objectCoords)
