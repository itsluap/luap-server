                ...
                items = {
                    {
                        ...
                        icon = 'user',
                        type = 'client',
                        event = 'indigo-radialmenu:ToggleClothing',
                        shouldClose = true
                    }, {
                        id = 'Ear',
                        title = 'Ear Piece',
                        icon = 'ear-deaf',
                        type = 'client',
                        event = 'indigo-radialmenu:ToggleProps',
                        shouldClose = true
                    }, {
                        id = 'Neck',
                        title = 'Neck',
    ...
    items = {
        {
            ...
            icon = 'box-open',
            type = 'client',
            event = 'indigo-radialmenu:client:setExtra',
            shouldClose = false
        }, {
            id = 'extra2',
            title = 'Extra 2',
            ...
            items = {
                {
                    ...
                    icon = 'plus',
                    type = 'client',
                    event = 'indigo-radialmenu:client:TakeStretcher',
                    shouldClose = false
                }, {
                    id = 'despawnstretcher',
                    ...
                    icon = 'minus',
                    type = 'client',
                    event = 'indigo-radialmenu:client:RemoveStretcher',
                    shouldClose = false
                }
            }
        }
