...
RegisterNetEvent('indigo-radialmenu:ResetClothing', ResetClothing)
...
RegisterNetEvent('indigo-radialmenu:ToggleClothing', ToggleClothing)
...
RegisterNetEvent('indigo-radialmenu:ToggleProps', ToggleProps)
