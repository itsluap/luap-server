...
RegisterNetEvent('indigo-fitbit:use', function()
    openWatch()
end)
...
RegisterNUICallback('setFoodWarning', function(data, cb)
    ...
    TriggerServerEvent('indigo-fitbit:server:setValue', 'food', foodValue)
...
RegisterNUICallback('setThirstWarning', function(data, cb)
    ...
    TriggerServerEvent('indigo-fitbit:server:setValue', 'thirst', thirstValue)
