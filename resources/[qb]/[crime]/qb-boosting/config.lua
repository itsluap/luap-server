...
Config['General'] = {
    ...
    ["PoliceJobName"] = "police", "sheriff", "trooper", -- police job name
    ["MinPolice"] = 0,
...
Config['CoreSettings'] = {
    ["QBCORE"] = {
        ...
        ["HasItem"] = "QBCore.Functions.HasItem", -- Imporant [ Your trigger for checking has item, default is CORENAME:HasItem ] 
