cfg.log = {
	...
	logs = { -- Available Logs
		["start"] = { -- This is the log that is used when a player starts the robbery.
			webhook = "https://discord.com/api/webhooks/1169949651387027466/UajCGYoaH10X3AFrYC-BqIAis3HRWVHZvDNw6RQi_4eSMAzPmDAuuqMTO9EkVbSIrK0m", -- This is the webhook that you have to set.
