			...
			options = {
				{
					...
					item_needed = {
						{"robbery_crack_device_keycard_pacific_01",1,100}, -- {item_name,item_amount,percentage_to_remove}
						{"robbery_tools_laptop_01",1,100}, -- {item_name,item_amount,percentage_to_remove}
					},
