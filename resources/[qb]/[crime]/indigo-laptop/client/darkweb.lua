...
local function openCrate(crate)
    ...
    QBCore.Functions.TriggerCallback('indigo-laptop:server:getCrateStatus', function(data)
...
local function breakCrate(entity)
    if haveItem('drill') then
        exports['ps-ui']:Thermite(function(success)
            if success then
                TriggerServerEvent('indigo-laptop:server:crateOpened', NetworkGetNetworkIdFromEntity(entity))
...
RegisterNetEvent('QBCore:Client:OnPlayerLoaded', function()
    QBCore.Functions.TriggerCallback('indigo-laptop:server:getAllCrates', function(crateInfo)
        crates = crateInfo
...
RegisterNetEvent('indigo-laptop:client:updateCrates', function(crateInfo)
    crates = crateInfo
end)
