...
Config.cdTime = 10000 -- global cooldown in ms. Set to 20 minutes by default - (https://www.timecalculator.net/minutes-to-milliseconds)
...
Config.cokeTime = 90000 -- time in ms the effects of coke will last for
