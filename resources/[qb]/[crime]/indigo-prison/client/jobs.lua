...
local function GetRandomCraftingItem(job)
    if job == 'janitor' then
        ...
        TriggerServerEvent('indigo-prison:server:GetCraftingItems', Config.JanitorItems[JanitorItem].item, Config.JanitorItems[JanitorItem].amount)
    ...
    elseif job == 'cook' then
        ...
        TriggerServerEvent('indigo-prison:server:GetCraftingItems', Config.CookItems[CookItem].item, Config.CookItems[CookItem].amount)
    ...
    elseif job == 'electrician' then
        ...
        TriggerServerEvent('indigo-prison:server:GetCraftingItems', Config.ElectricianItems[ElectricianItem].item, Config.ElectricianItems[ElectricianItem].amount)
