...
RegisterNetEvent('indigo-prison:server:getCommissary', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterNetEvent('indigo-prison:server:GetCraftingItems', function(item, amount)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
-- Get Crafted Item
RegisterNetEvent('indigo-prison:server:GetCraftedItem', function(data)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local item = data
...
RegisterNetEvent('indigo-prison:server:RemoveCraftingItems', function(item)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
QBCore.Functions.CreateCallback('indigo-prison:server:CraftingMaterials', function(source, cb, materials)
    local src = source
...
QBCore.Functions.CreateCallback('indigo-prison:server:DoesStashExist', function(source, cb, stashID)
    local retval = false
