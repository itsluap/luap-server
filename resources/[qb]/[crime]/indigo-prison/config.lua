...
Config.Crafting = true -- Set to false to disable crafting or if you own indigo-prisonjobs
...
-- If you are using indigo-prisonjobs by xThrasherrr#6666 then set this to true
