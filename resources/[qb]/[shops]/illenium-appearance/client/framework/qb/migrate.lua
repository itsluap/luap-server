...
RegisterNetEvent("illenium-appearance:client:migration:load-indigo-clothing-skin", function(playerSkin)
    ...
    Citizen.CreateThread(function()
        ...
        TriggerEvent("illenium-appearance:client:migration:load-indigo-clothing-clothes", playerSkin, cache.ped)
        SetModelAsNoLongerNeeded(model)
    end)
end)

RegisterNetEvent("illenium-appearance:client:migration:load-indigo-clothing-clothes", function(playerSkin, ped)
    ...
    TriggerServerEvent("illenium-appearance:server:migrate-indigo-clothing-skin", playerSkin.citizenid, appearance)
end)
