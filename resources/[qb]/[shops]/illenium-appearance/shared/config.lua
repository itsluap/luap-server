...
Config.ClothingRooms = {
    {
        job = "police",
        coords = vector4(462.2897, -998.8867, 30.6896, 270.0024),
        size = vector3(4, 4, 4),
        rotation = 0,
        usePoly = false,
        points = {
            -- new points -- 
            vector3(457.0817, -997.2463, 30.6896),
            vector3(458.8687, -995.4046, 30.6896),
            vector3(463.9893, -995.9245, 30.6896),
            vector3(463.9971, -999.7507, 30.6896),
            vector3(457.4864, -1000.0898, 30.6896)
        }
    }
}
