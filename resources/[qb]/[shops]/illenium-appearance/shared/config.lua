...
Config.ClothingRooms = {
    {
        job = "police",
        coords = vector4(462.5522, -998.9916, 30.6896, 269.7608),
        size = vector3(4, 4, 4),
        rotation = 0,
        usePoly = true,
        points = {
            vector2(456.93612670898, -997.06744384766),
            vector2(458.71420288086, -995.24291992188),
            vector2(464.0598449707, -995.50341796875),
            vector2(464.09274291992, -1000.2537231445),
            vector2(456.93798828125, -1000.3721313477),
            vector2(456.94812011719, -998.39074707031)
        }
    }
}
