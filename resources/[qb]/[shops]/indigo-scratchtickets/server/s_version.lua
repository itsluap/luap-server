CreateThread(function(resourceName)
  ...
  PerformHttpRequest('https://raw.githubusercontent.com/xDreamLand/dream-versions/main/indigo-scratchtickets-qbcore.json', function (errorCode, resultData, resultHeaders)
