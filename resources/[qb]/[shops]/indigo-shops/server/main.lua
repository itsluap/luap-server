...
RegisterNetEvent('indigo-shops:server:UpdateShopItems', function(shop, itemData, amount)
    ...
    TriggerClientEvent('indigo-shops:client:SetShopItems', -1, shop, Config.Locations[shop]["products"])
end)

RegisterNetEvent('indigo-shops:server:RestockShopItems', function(shop)
    ...
    TriggerClientEvent('indigo-shops:client:RestockShopItems', -1, shop, randAmount)
end)
...
RegisterNetEvent('indigo-shops:server:sellChips', function()
    local src = source
