...
-- Events
RegisterNetEvent("indigo-shops:client:UpdateShop", function(shop, itemData, amount)
    TriggerServerEvent("indigo-shops:server:UpdateShopItems", shop, itemData, amount)
end)

RegisterNetEvent("indigo-shops:client:SetShopItems", function(shop, shopProducts)
    Config.Locations[shop]["products"] = shopProducts
end)

RegisterNetEvent("indigo-shops:client:RestockShopItems", function(shop, amount)
