...
Config.Stores = {
    [1] = {shopType = 'clothing', coords = vector3(1693.32, 4823.48, 41.06), width = 8, length = 8},
    [2] = {shopType = 'clothing', coords = vector3(-712.215881, -155.352982, 37.4151268), width = 8, length = 8},
    [3] = {shopType = 'clothing', coords = vector3(-1192.94495, -772.688965, 17.3255997), width = 8, length = 8},
    [4] = {shopType = 'clothing', coords = vector3(425.236, -806.008, 28.491), width = 8, length = 8},
    [5] = {shopType = 'clothing', coords = vector3(-162.658, -303.397, 38.733), width = 8, length = 8},
    [6] = {shopType = 'clothing', coords = vector3(75.950, -1392.891, 28.376), width = 8, length = 8},
    [7] = {shopType = 'clothing', coords = vector3(-822.194, -1074.134, 10.328), width = 8, length = 8},
    [8] = {shopType = 'clothing', coords = vector3(-1450.711, -236.83, 48.809), width = 8, length = 8},
    [9] = {shopType = 'clothing', coords = vector3(4.254, 6512.813, 30.877), width = 8, length = 8},
    [10] = {shopType = 'clothing', coords = vector3(615.180, 2762.933, 41.088), width = 8, length = 8},
    [11] = {shopType = 'clothing', coords = vector3(1196.785, 2709.558, 37.222), width = 8, length = 8},
    [12] = {shopType = 'clothing', coords = vector3(-3171.453, 1043.857, 19.863), width = 8, length = 8},
    [13] = {shopType = 'clothing', coords = vector3(-1100.959, 2710.211, 18.107), width = 8, length = 8},
    --[14] = {shopType = 'clothing', coords = vector3(-1207.65, -1456.88, 4.3784737586975), width = 8, length = 8},
    [14] = {shopType = 'clothing', coords = vector3(121.76, -224.6, 53.56), width = 8, length = 8},
    [15] = {shopType = 'barber', coords = vector3(-814.3, -183.8, 36.6), width = 8, length = 8},
    [16] = {shopType = 'barber', coords = vector3(136.8, -1708.4, 28.3), width = 8, length = 8},
    [17] = {shopType = 'barber', coords = vector3(-1282.6, -1116.8, 6.0), width = 8, length = 8},
    [18] = {shopType = 'barber', coords = vector3(1931.5, 3729.7, 31.8), width = 8, length = 8},
    [19] = {shopType = 'barber', coords = vector3(1212.8, -472.9, 65.2), width = 8, length = 8},
    [20] = {shopType = 'barber', coords = vector3(-32.9, -152.3, 56.1), width = 8, length = 8},
    [21] = {shopType = 'barber', coords = vector3(-278.1, 6228.5, 30.7), width = 8, length = 8},
    [22] = {shopType = 'tattoo', coords = vector3(1322.6, -1651.9, 51.2), width = 8, length = 8},
    [23] = {shopType = 'tattoo', coords = vector3(-1153.6, -1425.6, 4.9), width = 8, length = 8},
    [24] = {shopType = 'tattoo', coords = vector3(322.1, 180.4, 103.5), width = 8, length = 8},
    [25] = {shopType = 'tattoo', coords = vector3(-3170.0, 1075.0, 20.8), width = 8, length = 8},
    [26] = {shopType = 'tattoo', coords = vector3(1864.6, 3747.7, 33.0), width = 8, length = 8},
    [27] = {shopType = 'tattoo', coords = vector3(-293.7, 6200.0, 31.4), width = 8, length = 8},
    [28] = {shopType = 'surgeon', coords = vector3(314.5717, -568.1820, 43.2841), width = 8, length = 8},

}

-- set isGang to true if the requiredJob is a gang
Config.ClothingRooms = {
    [1] = {requiredJob = 'police', isGang = false, coords = vector3(462.2431, -998.8978, 30.6896), width = 3, length = 3, cameraLocation = vector4(463.9745, -999.0157, 30.6896, 86.4446)},
    [2] = {requiredJob = 'ambulance', isGang = false, coords = vector3(298.77, -598.47, 43.28), width = 3, length = 3, cameraLocation = vector4(300.14, -599.12, 43.28, 70.56)}, -- Right double door in Hospital Map that is on QBCore GitHub
