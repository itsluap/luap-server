...
RegisterNetEvent('indigo-phone:server:UpdateMessages', function(ChatMessages, ChatNumber)
    ...
    if TargetData then
        ...
        if Chat[1] then
            ...
            TriggerClientEvent('indigo-phone:client:UpdateMessages', TargetData.PlayerData.source, ChatMessages, SenderData.PlayerData.charinfo.phone, false)
        else
            ...
            TriggerClientEvent('indigo-phone:client:UpdateMessages', TargetData.PlayerData.source, ChatMessages, SenderData.PlayerData.charinfo.phone, true)
        end
    else
