...
RegisterNetEvent('indigo-phone:server:RemoveMail', function(MailId)
    local src = source
    ...
    SetTimeout(100, function()
        ...
        TriggerClientEvent('indigo-phone:client:UpdateMails', src, mails)
    end)
end)


RegisterNetEvent('indigo-phone:server:sendNewMail', function(mailData, citizenID)
    ...
    if Player then
        ...
        TriggerClientEvent('indigo-phone:client:NewMailNotify', Player.PlayerData.source, mailData)
        ...
        SetTimeout(200, function()
            ...
            TriggerClientEvent('indigo-phone:client:UpdateMails', Player.PlayerData.source, mails)
        end)
