...
RegisterNUICallback('AcceptMailButton', function(data, cb)
    ...
    TriggerServerEvent('indigo-phone:server:ClearButtonData', data.mailId)
    cb('ok')
end)
...
RegisterNUICallback('RemoveMail', function(data, cb)
    ...
    TriggerServerEvent('indigo-phone:server:RemoveMail', MailId)
    cb('ok')
end)

-- Events

RegisterNetEvent('indigo-phone:client:NewMailNotify', function(MailData)
...
RegisterNetEvent('indigo-phone:client:UpdateMails', function(NewMails)
