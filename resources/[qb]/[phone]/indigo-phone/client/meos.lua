...
RegisterNUICallback('FetchVehicleResults', function(data, cb)
    QBCore.Functions.TriggerCallback('indigo-phone:server:GetVehicleSearchResults', function(result)
        if result then
...
RegisterNUICallback('FetchVehicleScan', function(_, cb)
    ...
    QBCore.Functions.TriggerCallback('indigo-phone:server:ScanPlate', function(result)
        QBCore.Functions.TriggerCallback('police:IsPlateFlagged', function(flagged)
