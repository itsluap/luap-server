...
RegisterNUICallback('PostNewTweet', function(data, cb)
    ...
    TriggerServerEvent('indigo-phone:server:UpdateTweets', TweetMessage)
    cb("ok")
end)

RegisterNUICallback('DeleteTweet',function(data)
    TriggerServerEvent('indigo-phone:server:DeleteTweet', data.id)
end)
...
RegisterNetEvent('indigo-phone:client:UpdateTweets', function(src, Tweets, delete)
