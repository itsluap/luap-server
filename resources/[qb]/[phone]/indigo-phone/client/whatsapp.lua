...
RegisterNUICallback('SendMessage', function(data, cb)
    ...
    TriggerServerEvent('indigo-phone:server:UpdateMessages', PhoneData.Chats[ChatNumber].messages, ChatNumber)
    SendNUIMessage({
        action = "UpdateChat",
...
RegisterNetEvent('indigo-phone:client:UpdateMessages', function(ChatMessages, SenderNumber, New)
