...
function getDocuments(){
    ...
    $.post('https://indigo-phone/GetNote_for_Documents_app', JSON.stringify({}), function(HasNote){
        if(HasNote){
...
$(document).on('click', '#documents-send-perm', function(e){
    ...
    if(NewText != ""){
        $.post('https://indigo-phone/document_Send_Note', JSON.stringify({
            Title: DocEndtitle,
            Text: NewText,
            Time: Times,
            ID: DocEndid,
...
$(document).on('click', '#documents-save-note-for-doc', function(e){
    ...
    if ((Title && Text) != ""){
        $.post('https://indigo-phone/documents_Save_Note_As', JSON.stringify({
            Title: Title,
            Text: Text,
            Time: Times,
            Type: "New",
