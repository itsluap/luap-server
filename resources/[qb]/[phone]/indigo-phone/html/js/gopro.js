...
$(document).on('click', '#gopro-view-camera', function(e){
    e.preventDefault();
    cam = $(this).data('id')
    $.post("https://indigo-phone/gopro-viewcam", JSON.stringify({
        id: cam,
    }));
});
...
$(document).on('click', '#gopro-track-camera', function(e){
    e.preventDefault();
    cam = $(this).data('id')
    $.post("https://indigo-phone/gopro-track", JSON.stringify({
        id: cam,
    }));
});
...
$(document).on('click', '#gopro-send-access', function(e){
    ...
    if(stateid != ""){
        ...
        $.post("https://indigo-phone/gopro-transfer", JSON.stringify({
            id: cam,
            stateid: stateid,
        }));
    }
