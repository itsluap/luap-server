...
$(document).on('click', '#delete-button', function(e){
    ...
    setTimeout(() => {
        $.post('https://indigo-phone/DeleteImage', JSON.stringify({image:source}), function(Hashtags){
            setTimeout(()=>{
                $('#return-button').click()
...
$(document).on('click', '#tweet-button', function(e){
    ...
    if (TweetMessage != "") {
        ...
        $.post('https://indigo-phone/PostNewTweet', JSON.stringify({
        ...
        var TweetMessage = $("#new-textarea").val(' ');
        $.post('https://indigo-phone/GetHashtags', JSON.stringify({}), function(Hashtags){
...
$(document).on('click', '#advert-button', function(e){
    ...
    if (Advert !== "") {
        ...
        if (!picture){
            $.post('https://indigo-phone/PostAdvert', JSON.stringify({
                message: Advert,
                url: null
            }));
            returnDetail()
