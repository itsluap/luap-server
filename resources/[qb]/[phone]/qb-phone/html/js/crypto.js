        ...
        for (const [k, v] of Object.entries(Jobs)) {
            ...
            if (v.purchase){
                ...
                '<div class="crypto-block">' +
                    ...
                    '<div class="crypto-box"><span class="crypto-box box-purchase" data-cryptometa="'+v.metadata+'" data-label="'+v.label+'" style="margin-left: 0.1vh;">PURCHASE</span><span class="crypto-box box-exchange" data-cryptometa="'+v.metadata+'" data-label="'+v.label+'" style = "margin-left: 0.6vh;">EXCHANGE</span><span class="crypto-box box-sell" data-cryptometa="'+v.metadata+'" data-label="'+v.label+'" style="margin-left: 0.8vh;">SELL</span></div>' +
                    '</div>' +
                '</div>';
            }else{
                var AddOption = '<div class="crypto-list" id="crypto-id" ><span class="crypto-icon"><i class="'+v.icon+'"></i></span> <span class="crypto-label">'+v.label+'</span> <span class="crypto-value">'+CryptoType[Crypto]+'</span>' +
