        ...
        for (const [k, v] of Object.entries(Jobs)) {
            ...
            if (v.purchase){
                ...
                '<div class="crypto-block">' +
                    ...
                    '<div class="crypto-current"><i class="fas fa-money-check-alt"></i>'+CryptoType[Crypto]+'</div>' +
                    '<div class="crypto-cost"><i class="fas fa-chart-bar"></i>'+formatter.format(v.value)+'</div>' +
                    '<div class="crypto-box"><span class="crypto-box box-exchange" data-cryptometa="'+v.metadata+'" data-label="'+v.label+'" style = "margin-left: 0.5vh;">EXCHANGE</span><span class="crypto-box box-sell" data-cryptometa="'+v.metadata+'" data-label="'+v.label+'" style="margin-left: 1.1vh;">SELL</span></div>' +
                    '</div>' +
                '</div>';
            }
