local Translations = {
    ...
    credit = {
        there_are_amount_credited = '¡Hay %{amount} Bitcoin(s) acreditados!',
        you_have_qbit_purchased = 'Has comprado %{dataCoins} Bitcoin(s)!'
    },
    depreciation = {
        you_have_sold = 'Has vendido %{dataCoins} Bitcoin(s)!'
    },
    text = {
        ...
        this_crypto_does_not_exist = 'Este Crypto no existe :(, disponible: Bitcoin',
        you_have_not_provided_crypto_available_qbit = 'No ha proporcionado Crypto, disponible: Bitcoin',
        the_qbit_has_a_value_of = 'El Bitcoin tiene un valor de: ${crypto}',
