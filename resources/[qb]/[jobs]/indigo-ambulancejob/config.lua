Config = {}
Config.UseTarget = GetConvar('UseTarget', 'false') == 'true' -- Use indigo-target interactions (don't change this, go to your server.cfg and add setr UseTarget true)
...
Config.Locations = { -- Edit the various interaction points for players or create new ones
    ...
    ["duty"] = {
        [1] = vector3(307.14, -597.46, 43.28),
        [2] = vector3(-254.88, 6324.5, 32.58),
    },
    ["vehicle"] = {
        [1] = vector4(326.25, -588.6, 28.8, 340.11),
    ...
    ["beds"] = {
        [1] = {coords = vector4(322.71, -587.19, 44.2, 340.96), taken = false, model = 1631638868},
        [2] = {coords = vector4(313.84, -579.21, 44.2, 158.37), taken = false, model = 1631638868},
