...
RegisterNetEvent('hospital:client:RespawnAtHospital', function()
    ...
    if exports["indigo-policejob"]:IsHandcuffed() then
        ...
        while listen do
            if IsControlJustPressed(0, 38) then
                ...
                elseif variable == "beds" then
                    TriggerEvent('indigo-ambulancejob:beds')
                    listen = false
                end
            end
            Wait(1)
...
RegisterNetEvent('indigo-ambulancejob:checkin', function()
    --[[
...
RegisterNetEvent('indigo-ambulancejob:beds', function()
                ...
                options = {
                    {
                        ...
                        event = "indigo-ambulancejob:checkin",
                        label = "Check In",
                    }
                },
                distance = 1.5
        ...
        for k, v in pairs(Config.Locations["beds"]) do
            exports['qb-target']:AddBoxZone("beds"..k,  v.coords, 2.5, 2.3, {
                ...
                options = {
                    {
                        type = "client",
                        event = "indigo-ambulancejob:beds",
                        icon = "fas fa-bed",
                        label = "Layin Bed",
                    }
                },
