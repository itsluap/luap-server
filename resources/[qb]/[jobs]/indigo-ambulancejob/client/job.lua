        ...
        while check do
            if IsControlJustPressed(0, 38) then
                ...
                elseif variable == "stash" then
                    TriggerEvent('indigo-ambulancejob:stash')
                elseif variable == "armory" then
                    TriggerEvent('indigo-ambulancejob:armory')
                elseif variable == "storeheli" then
                    TriggerEvent('indigo-ambulancejob:storeheli')
                elseif variable == "takeheli" then
                    TriggerEvent('indigo-ambulancejob:pullheli')
                elseif variable == "roof" then
                    TriggerEvent('indigo-ambulancejob:elevator_main')
                elseif variable == "main" then
                    TriggerEvent('indigo-ambulancejob:elevator_roof')
                end
            end
            Wait(1)
        end
...
RegisterNetEvent('indigo-ambulancejob:stash', function()
    if onDuty then
...
RegisterNetEvent('indigo-ambulancejob:armory', function()
    if onDuty then
...
RegisterNetEvent('indigo-ambulancejob:elevator_roof', function()
    local ped = PlayerPedId()
...
RegisterNetEvent('indigo-ambulancejob:elevator_main', function()
    local ped = PlayerPedId()
        ...
        for k, v in pairs(Config.Locations["stash"]) do
            exports['qb-target']:AddBoxZone("stash" .. k, vector3(v.x, v.y, v.z), 1, 1, {
                ...
                options = {
                    {
                        type = "client",
                        event = "indigo-ambulancejob:stash",
                        icon = "fa fa-hand",
                        label = "Open Stash",
                        job = "ambulance"
                    }
        ...
        for k, v in pairs(Config.Locations["armory"]) do
            exports['qb-target']:AddBoxZone("armory" .. k, vector3(v.x, v.y, v.z), 1, 1, {
                ...
                options = {
                    {
                        type = "client",
                        event = "indigo-ambulancejob:armory",
                        icon = "fa fa-hand",
                        label = "Open Armory",
                        job = "ambulance"
                    }
        ...
        for k, v in pairs(Config.Locations["roof"]) do
            exports['qb-target']:AddBoxZone("roof" .. k, vector3(v.x, v.y, v.z), 2, 2, {
                ...
                options = {
                    {
                        type = "client",
                        event = "indigo-ambulancejob:elevator_roof",
        ...
        for k, v in pairs(Config.Locations["main"]) do
            exports['qb-target']:AddBoxZone("main" .. k, vector3(v.x, v.y, v.z), 1.5, 1.5, {
                ...
                options = {
                    {
                        type = "client",
                        event = "indigo-ambulancejob:elevator_main",
                        icon = "fas fa-hand-point-up",
                        label = "Take Elevator",
                        job = "ambulance"
                    },
