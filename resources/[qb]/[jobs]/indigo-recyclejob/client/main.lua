  ...
  if Config.UseTarget then
    entranceZone = exports['indigo-target']:AddBoxZone(entranceTargetID, coords, 1, 4, {
      ...
      options = {
        {
          type = 'client',
          event = 'indigo-recyclejob:client:target:enterLocation',
  ...
  if Config.UseTarget then
    exitZone = exports['indigo-target']:AddBoxZone(exitTargetID, coords, 1, 4, {
      ...
      options = {
        {
          type = 'client',
          event = 'indigo-recyclejob:client:target:exitLocation',
  ...
  if Config.UseTarget then
    dutyZone = exports['indigo-target']:AddBoxZone(dutyTargetID, coords, 1, 1, {
      ...
      options = {
        {
          type = 'client',
          event = 'indigo-recyclejob:client:target:toggleDuty',
  ...
  if Config.UseTarget then
    deliveryZone = exports['indigo-target']:AddBoxZone(deliveryTargetID, coords, 1, 1, {
      ...
      options = {
        {
          type = 'client',
          event = 'indigo-recyclejob:client:target:dropPackage',
  ...
  if Config.UseTarget then
    pickupZone = exports['indigo-target']:AddBoxZone(pickupTargetID, targetCoords, 4, 1.5, {
      ...
      options = {
        {
          type = 'client',
          event = 'indigo-recyclejob:client:target:pickupPackage',
...
RegisterNetEvent('indigo-recyclejob:client:target:enterLocation', function()
  EnterLocation()
end)

RegisterNetEvent('indigo-recyclejob:client:target:exitLocation', function()
  ExitLocation()
end)

RegisterNetEvent('indigo-recyclejob:client:target:toggleDuty', function()
  onDuty = not onDuty
  if onDuty then
...
RegisterNetEvent('indigo-recyclejob:client:target:pickupPackage', function()
...
RegisterNetEvent('indigo-recyclejob:client:target:dropPackage', function()
