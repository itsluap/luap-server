...
CreateThread(function()
	...
	if Config.MLO == "GN" then
		...
		--Stash/Shops
		Targets["BShelf"] =
		exports['indigo-target']:AddBoxZone("BShelf", vector3(-1195.29, -897.51, 13.97), 3.0, 1.0, { name="BShelf", heading = 35.0, debugPoly=Config.Debug, minZ = 13.7, maxZ = 14.77, },
			{ options = { { event = "jim-burgershot:Stash", icon = "fas fa-box-open", label = Loc[Config.Lan].targetinfo["open_shelves"], job = "burgershot", id = "Shelf" }, },
				distance = 2.0 })
		Targets["BFridge"] =
		exports['indigo-target']:AddBoxZone("BFridge", vector3(-1201.31, -901.69, 13.97), 3.8, 0.6, { name="BFridge", heading = 35.0, debugPoly=Config.Debug, minZ = 13.0, maxZ = 14.5, },
			{ options = { { event = "jim-burgershot:Stash", icon = "fas fa-temperature-low", label = Loc[Config.Lan].targetinfo["open_fridge"], job = "burgershot", id = "Fridge" }, },
				distance = 1.5 })
		Targets["BStore"] =
		exports['indigo-target']:AddBoxZone("BStore", vector3(-1198.5, -904.02, 13.97), 0.4, 1.4, { name="BStore", heading = 213.65, debugPoly=Config.Debug, minZ = 12.97, maxZ = 15.37, },
			{ options = { { event = "jim-burgershot:shop", icon = "fas fa-temperature-low", label = Loc[Config.Lan].targetinfo["open_storage"], job = "burgershot" }, },
				distance = 1.5 })
		Targets["BBag"] =
		exports['indigo-target']:AddBoxZone("BBag", vector3(-1196.52, -902.07, 13.97), 0.7, 0.5, { name="BBag", heading = 305.0, debugPoly=Config.Debug, minZ = 12.97, maxZ = 14.57, },
		...
		--Food Making
		Targets["BGrill"] =
		exports['indigo-target']:AddBoxZone("BGrill", vector3(-1198.27, -895.3, 14.0), 0.7, 1.2, { name="BGrill", heading = 34.93, debugPoly=Config.Debug, minZ = 13.3, maxZ = 14.5, },
			{ options = { { event = "jim-burgershot:Crafting", icon = "fas fa-fire", label = Loc[Config.Lan].targetinfo["use_grill"], job = "burgershot", craftable = Crafting.Grill, header = Loc[Config.Lan].menu["grill"] }, },
				distance = 1.5 })
		Targets["BFryer"] =
		exports['indigo-target']:AddBoxZone("BFryer", vector3(-1200.85, -896.84, 13.97), 0.6, 1.6, { name="BFryer", heading = 34.0, debugPoly=Config.Debug, minZ = 12.97, maxZ = 14.57, },
			{ options = { { event = "jim-burgershot:Crafting", icon = "fas fa-temperature-high", label = Loc[Config.Lan].targetinfo["use_deepfryer"], job = "burgershot", craftable = Crafting.Fryer, header = Loc[Config.Lan].menu["deep_fat_fryer"] }, },
				distance = 1.5 })
		Targets["BChop"] =
		exports['indigo-target']:AddBoxZone("BChop", vector3(-1197.19, -898.18, 14.0), 0.6, 1.5, { name="BChop", heading = 213.93, debugPoly=Config.Debug, minZ = 13.3, maxZ = 14.5, },
			{ options = { { event = "jim-burgershot:Crafting", icon = "fas fa-utensils", label = Loc[Config.Lan].targetinfo["use_chopping_board"], job = "burgershot", craftable = Crafting.ChopBoard, header = Loc[Config.Lan].menu["chopping_board"] }, },
				distance = 1.5 })
		Targets["BPrepare"] =
		exports['indigo-target']:AddBoxZone("BPrepare", vector3(-1196.54, -899.28, 13.98), 0.6, 1.5, { name="BPrepare", heading = 34.93, debugPoly=Config.Debug, minZ = 13.3, maxZ = 14.5, },
			{ options = { { event = "jim-burgershot:Crafting", icon = "fas fa-hamburger", label = Loc[Config.Lan].targetinfo["prepare_food"], job = "burgershot", craftable = Crafting.Prepare, header = Loc[Config.Lan].menu["prepare_food"] }, },
				distance = 1.5 })
		Targets["BDrink"] =
		exports['indigo-target']:AddBoxZone("BDrink", vector3(-1197.25, -894.48, 13.97), 2.0, 0.6, { name="BDrink", heading = 35.0, debugPoly=Config.Debug, minZ = 13.97, maxZ = 14.97, },
			{ options = { { event = "jim-burgershot:Crafting", icon = "fas fa-mug-hot", label = Loc[Config.Lan].targetinfo["prepare_drinks"], job = "burgershot", craftable = Crafting.Drink, header = Loc[Config.Lan].menu["drinks_dispenser"] }, },
				distance = 1.5 })
		Targets["BDonut"] =
		exports['indigo-target']:AddBoxZone("BDonut", vector3(-1196.52, -895.74, 13.97), 0.8, 0.6, { name="BDonut", heading = 35.0, debugPoly=Config.Debug, minZ = 13.97, maxZ = 15.17, },
		...
		--Trays
		Targets["BTray1"] =
		exports['indigo-target']:AddBoxZone("BTray1", vector3(-1194.29, -893.85, 14.2), 0.6, 1.0, { name="BTray1", heading = 215.0, debugPoly=Config.Debug, minZ = 13.5, maxZ = 14.8, },
			{ options = { { event = "jim-burgershot:Stash", icon = "fas fa-hamburger", label = Loc[Config.Lan].targetinfo["open_tray"], id = "Tray1" }, },
				distance = 2.0 })
		Targets["BTray2"] =
		exports['indigo-target']:AddBoxZone("BTray2", vector3(-1193.39, -895.42, 14.2), 0.6, 1.0, { name="BTray2", heading = 215.0, debugPoly=Config.Debug, minZ = 13.5, maxZ = 14.8, },
			{ options = { { event = "jim-burgershot:Stash", icon = "fas fa-hamburger", label = Loc[Config.Lan].targetinfo["open_tray"], id = "Tray2" }, },
				distance = 2.0 })
		Targets["BTray3"] =
		exports['indigo-target']:AddBoxZone("BTray3", vector3(-1192.39, -896.86, 14.2), 0.6, 1.0, { name="BTray3", heading = 215.0, debugPoly=Config.Debug, minZ = 13.5, maxZ = 14.8, },
			{ options = { { event = "jim-burgershot:Stash", icon = "fas fa-hamburger", label = Loc[Config.Lan].targetinfo["open_tray"], id = "Tray3" }, },
				distance = 2.0 })

		--Hand Washing
		Targets["BWash1"] =
		exports['indigo-target']:AddBoxZone("BWash1", vector3(-1197.61, -902.73, 13.98), 0.6, 0.8, { name="BWash1", heading = 300.0, debugPoly=Config.Debug, minZ = 13.3, maxZ = 14.5, },
			{ options = { { event = "jim-burgershot:washHands", icon = "fas fa-hand-holding-water", label = Loc[Config.Lan].targetinfo["wash_hands"], }, },
				distance = 2.0 })
		Targets["BWash2"] =
		exports['indigo-target']:AddBoxZone("BWash2", vector3(-1205.24, -893.9, 13.98), 1.1, 0.8, { name="BWash2", heading = 122.65, debugPoly=Config.Debug, minZ = 13.3, maxZ = 14.5, },
			{ options = { { event = "jim-burgershot:washHands", icon = "fas fa-hand-holding-water", label = Loc[Config.Lan].targetinfo["wash_hands"], }, },
				distance = 2.0 })
		Targets["BWash3"] =
		exports['indigo-target']:AddBoxZone("BWash3", vector3(-1206.01, -892.84, 13.98), 0.6, 0.6, { name="BWash3", heading = 122.0, debugPoly=Config.Debug, minZ = 13.3, maxZ = 14.5, },
			{ options = { { event = "jim-burgershot:washHands", icon = "fas fa-hand-holding-water", label = Loc[Config.Lan].targetinfo["wash_hands"], }, },
				distance = 2.0 })
		Targets["BWash4"] =
		exports['indigo-target']:AddBoxZone("BWash4", vector3(-1201.96, -890.09, 13.98), 0.6, 0.6, { name="BWash4", heading = 122.0, debugPoly=Config.Debug, minZ = 13.3, maxZ = 14.5, },
			{ options = { { event = "jim-burgershot:washHands", icon = "fas fa-hand-holding-water", label = Loc[Config.Lan].targetinfo["wash_hands"], }, },
				distance = 2.0 })
		Targets["BWash5"] =
		exports['indigo-target']:AddBoxZone("BWash5", vector3(-1201.16, -891.14, 13.98), 0.6, 0.6, { name="BWash5", heading = 122.0, debugPoly=Config.Debug, minZ = 13.3, maxZ = 14.5, },
			{ options = { { event = "jim-burgershot:washHands", icon = "fas fa-hand-holding-water", label = Loc[Config.Lan].targetinfo["wash_hands"], }, },
				distance = 2.0 })

		--Payments / Clockin
		Targets["BReceipt"] =
		exports['indigo-target']:AddCircleZone("BReceipt", vector3(-1194.95, -893.15, 14.15), 0.5, { name="BReceipt", debugPoly=Config.Debug, useZ=true, },
		{ options = { { event = "jim-payments:client:Charge", icon = "fas fa-credit-card", label = Loc[Config.Lan].targetinfo["charge_customer"], job = "burgershot",
				...
				distance = 1.5 })
		Targets["BReceipt2"] =
		exports['indigo-target']:AddCircleZone("BReceipt2", vector3(-1193.97, -894.67, 14.15), 0.5, { name="BReceipt2", debugPoly=Config.Debug, useZ=true, },
		{ options = { { event = "jim-payments:client:Charge", icon = "fas fa-credit-card", label = Loc[Config.Lan].targetinfo["charge_customer"], job = "burgershot",
						img = "<center><p><img src=https://static.wikia.nocookie.net/gtawiki/images/b/bf/BurgerShot-HDLogo.svg width=225px></p>" }, },
				distance = 1.5 })
		Targets["BReceipt3"] =
		exports['indigo-target']:AddCircleZone("BReceipt3", vector3(-1192.93, -896.24, 14.15), 0.5, { name="BReceipt3", debugPoly=Config.Debug, useZ=true, },
		{ options = { { event = "jim-payments:client:Charge", icon = "fas fa-credit-card", label = Loc[Config.Lan].targetinfo["charge_customer"], job = "burgershot",
						img = "<center><p><img src=https://static.wikia.nocookie.net/gtawiki/images/b/bf/BurgerShot-HDLogo.svg width=225px></p>" }, },
				distance = 1.5 })
		Targets["BClockin"] =
		exports['indigo-target']:AddBoxZone("BClockin", vector3(-1179.06, -896.32, 13.97), 0.6, 0.6, { name="BClockin", heading = 10.0, debugPoly=Config.Debug, minZ = 13.57, maxZ = 14.57, },
	...
	if Config.MLO == "LP" then
		...
		--Stash/Shops
		Targets["BShelf"] =
		exports['indigo-target']:AddBoxZone("BShelf", vector3(-1197.75, -894.31, 14.19), 1.1, 4.5, { name="BShelf", heading = 123.65, debugPoly=Config.Debug, minZ = 13.0, maxZ = 14.9, },
			{ options = { { event = "jim-burgershot:Stash", icon = "fas fa-box-open", label = Loc[Config.Lan].targetinfo["open_shelves"], job = "burgershot", id = "Shelf" }, },
				distance = 2.0 })
		Targets["BFridge"] =
		exports['indigo-target']:AddBoxZone("BFridge", vector3(-1203.9, -889.75, 13.99), 1.2, 1.6, { name="BFridge", heading = 215.0, debugPoly=Config.Debug, minZ = 13.0, maxZ = 14.5, },
			{ options = { { event = "jim-burgershot:Stash", icon = "fas fa-temperature-low", label = Loc[Config.Lan].targetinfo["open_fridge"], job = "burgershot", id = "Fridge" }, },
				distance = 1.5 })
		Targets["BStore"] =
		exports['indigo-target']:AddBoxZone("BStore", vector3(-1205.75, -892.99, 13.99), 1.0, 4.5, { name="BStore", heading = 122.65, debugPoly=Config.Debug, minZ = 13.2, maxZ = 15.5, },
			{ options = { { event = "jim-burgershot:shop", icon = "fas fa-temperature-low", label = Loc[Config.Lan].targetinfo["open_storage"], job = "burgershot" }, },
				distance = 1.5 })
		Targets["BBag"] =
		exports['indigo-target']:AddBoxZone("BBag", vector3(-1200.51, -896.17, 14.0), 0.5, 0.7, { name="BBag", heading = 304.0, debugPoly=Config.Debug, minZ = 13.6, maxZ = 14.6, },
			{ options = { { event = "jim-burgershot:client:GrabBag", icon = "fas fa-bag-shopping", label = Loc[Config.Lan].targetinfo["grab_murderbag"], job = "burgershot", }, },
				distance = 2.0 })

		--Food Making
		Targets["BGrill1"] =
		exports['indigo-target']:AddBoxZone("BGrill1", vector3(-1200.27, -900.76, 14.0), 0.7, 1.2, { name="BGrill1", heading = 123.65, debugPoly=Config.Debug, minZ = 13.3, maxZ = 14.5, },
			{ options = { { event = "jim-burgershot:Crafting", icon = "fas fa-fire", label = Loc[Config.Lan].targetinfo["use_grill"], job = "burgershot", craftable = Crafting.Grill, header = Loc[Config.Lan].menu["grill"] }, },
				distance = 1.5 })
		Targets["BGrill2"] =
		exports['indigo-target']:AddBoxZone("BGrill2", vector3(-1202.64, -897.27, 14.0), 0.7, 1.2, { name="BGrill2", heading = 122.65, debugPoly=Config.Debug, minZ = 13.3, maxZ = 14.5, },
			{ options = { { event = "jim-burgershot:Crafting", icon = "fas fa-fire", label = Loc[Config.Lan].targetinfo["use_grill"], job = "burgershot", craftable = Crafting.Grill, header = Loc[Config.Lan].menu["grill"] }, },
				distance = 1.5 })
		Targets["BFryer"] =
		exports['indigo-target']:AddBoxZone("BFryer", vector3(-1201.4, -898.98, 13.98), 0.7, 2.5, { name="BFryer", heading = 123.65, debugPoly=Config.Debug, minZ = 13.3, maxZ = 14.5, },
			{ options = { { event = "jim-burgershot:Crafting", icon = "fas fa-temperature-high", label = Loc[Config.Lan].targetinfo["use_deepfryer"], job = "burgershot", craftable = Crafting.Fryer, header = Loc[Config.Lan].menu["deep_fat_fryer"] }, },
				distance = 1.5 })
		Targets["BChop"] =
		exports['indigo-target']:AddBoxZone("BChop", vector3(-1199.38, -902.07, 14.0), 0.6, 1.5, { name="BChop", heading = 123.65, debugPoly=Config.Debug, minZ = 13.3, maxZ = 14.5, },
			{ options = { { event = "jim-burgershot:Crafting", icon = "fas fa-utensils", label = Loc[Config.Lan].targetinfo["use_chopping_board"], job = "burgershot", craftable = Crafting.ChopBoard, Loc[Config.Lan].menu["chopping_board"] }, },
				distance = 1.5 })
		Targets["BPrepare"] =
		exports['indigo-target']:AddBoxZone("BPrepare", vector3(-1198.37, -898.36, 13.98), 1.8, 3.2, { name="BPrepare", heading = 123.65, debugPoly=Config.Debug, minZ = 13.3, maxZ = 14.5, },
			{ options = { { event = "jim-burgershot:Crafting", icon = "fas fa-hamburger", label = Loc[Config.Lan].targetinfo["prepare_food"], job = "burgershot", craftable = Crafting.Prepare, Loc[Config.Lan].menu["prepare_food"] }, },
				distance = 1.5 })
		Targets["BDrink"] =
		exports['indigo-target']:AddBoxZone("BDrink", vector3(-1199.47, -895.44, 13.9953), 0.6, 1.7, { name="BDrink", heading = 122.65, debugPoly=Config.Debug, minZ = 13.3, maxZ = 15.0, },
			{ options = { { event = "jim-burgershot:Crafting", icon = "fas fa-mug-hot", label = Loc[Config.Lan].targetinfo["prepare_drinks"], job = "burgershot", craftable = Crafting.Drink, header = Loc[Config.Lan].menu["drinks_dispenser"] }, },
				distance = 1.5 })
		Targets["BDonut"] =
		exports['indigo-target']:AddBoxZone("BDonut", vector3(-1203.35, -895.66, 13.9952), 0.7, 1.0, { name="BDonut", heading = 122.65, debugPoly=Config.Debug, minZ = 13.3, maxZ = 14.8, },
			{ options = { { event = "jim-burgershot:Crafting", icon = "fas fa-dot-circle", label = Loc[Config.Lan].targetinfo["open_cabinet"], job = "burgershot", craftable = Crafting.Donut, header = Loc[Config.Lan].menu["food_cabinet"] }, },
				distance = 1.5 })

		--Trays
		Targets["BTray1"] =
		exports['indigo-target']:AddBoxZone("BTray1", vector3(-1196.3, -890.7, 14.0), 0.6, 1.0, { name="BTray1", heading = 215.0, debugPoly=Config.Debug, minZ = 13.5, maxZ = 14.8, },
			{ options = { { event = "jim-burgershot:Stash", icon = "fas fa-hamburger", label = Loc[Config.Lan].targetinfo["open_tray"], id = "Tray1" }, },
				distance = 2.0 })
		Targets["BTray2"] =
		exports['indigo-target']:AddBoxZone("BTray2", vector3(-1195.0, -892.68, 14.0), 0.6, 1.0, { name="BTray2", heading = 215.0, debugPoly=Config.Debug, minZ = 13.5, maxZ = 14.8, },
			{ options = { { event = "jim-burgershot:Stash", icon = "fas fa-hamburger", label = Loc[Config.Lan].targetinfo["open_tray"], id = "Tray2" }, },
				distance = 2.0 })
		Targets["BTray3"] =
		exports['indigo-target']:AddBoxZone("BTray3", vector3(-1193.86, -894.4, 14.0), 0.6, 1.0, { name="BTray3", heading = 215.0, debugPoly=Config.Debug, minZ = 13.5, maxZ = 14.8, },
			{ options = { { event = "jim-burgershot:Stash", icon = "fas fa-hamburger", label = Loc[Config.Lan].targetinfo["open_tray"], id = "Tray3" }, },
				distance = 2.0 })

		--Hand Washing
		Targets["BWash1"] =
		exports['indigo-target']:AddBoxZone("BWash1", vector3(-1197.12, -902.07, 13.98), 0.6, 1.0, { name="BWash1", heading = 215.0, debugPoly=Config.Debug, minZ = 13.3, maxZ = 14.5, },
			{ options = { { event = "jim-burgershot:washHands", icon = "fas fa-hand-holding-water", label = Loc[Config.Lan].targetinfo["wash_hands"], }, },
				distance = 2.0 })
		Targets["BWash2"] =
		exports['indigo-target']:AddBoxZone("BWash2", vector3(-1198.23, -902.78, 13.98), 1.1, 0.8, { name="BWash2", heading = 215.65, debugPoly=Config.Debug, minZ = 13.3, maxZ = 14.5, },
			{ options = { { event = "jim-burgershot:washHands", icon = "fas fa-hand-holding-water", label = Loc[Config.Lan].targetinfo["wash_hands"], }, },
				distance = 2.0 })
		Targets["BWash3"] =
		exports['indigo-target']:AddBoxZone("BWash3", vector3(-1200.7, -888.98, 14.0), 0.6, 0.6, { name="BWash3", heading = 34.93, debugPoly=Config.Debug, minZ = 13.2, maxZ = 14.6, },
			{ options = { { event = "jim-burgershot:washHands", icon = "fas fa-hand-holding-water", label = Loc[Config.Lan].targetinfo["wash_hands"], }, },
				distance = 2.0 })
		Targets["BWash4"] =
		exports['indigo-target']:AddBoxZone("BWash4", vector3(-1198.57, -887.54, 14.0), 0.6, 0.6, { name="BWash4", heading = 215.0, debugPoly=Config.Debug, minZ = 13.2, maxZ = 14.6, },
			{ options = { { event = "jim-burgershot:washHands", icon = "fas fa-hand-holding-water", label = Loc[Config.Lan].targetinfo["wash_hands"], }, },
				distance = 2.0 })

		--Payments / Clockin
		Targets["BReceipt"] =
		exports['indigo-target']:AddCircleZone("BReceipt", vector3(-1196.04, -891.38, 14.15), 0.5, { name="BReceipt", debugPoly=Config.Debug, useZ=true, },
			{ options = { { event = "jim-payments:client:Charge", icon = "fas fa-credit-card", label = Loc[Config.Lan].targetinfo["charge_customer"], job = "burgershot" }, },
				distance = 1.5 })
		Targets["BReceipt2"] =
		exports['indigo-target']:AddCircleZone("BReceipt2", vector3(-1194.7, -893.32, 14.15), 0.5, { name="BReceipt2", debugPoly=Config.Debug, useZ=true, },
			{ options = { { event = "jim-payments:client:Charge", icon = "fas fa-credit-card", label = Loc[Config.Lan].targetinfo["charge_customer"], job = "burgershot", }, },
				distance = 1.5 })
		Targets["BReceipt3"] =
		exports['indigo-target']:AddCircleZone("BReceipt3", vector3(-1193.42, -895.22, 14.15), 0.5, { name="BReceipt3", debugPoly=Config.Debug, useZ=true, },
			{ options = { { event = "jim-payments:client:Charge", icon = "fas fa-credit-card", label = Loc[Config.Lan].targetinfo["charge_customer"], job = "burgershot",}, },
				distance = 2.0 })
		Targets["BClockin"] =
		exports['indigo-target']:AddBoxZone("BClockin", vector3(-1193.18, -898.13, 14.2), 0.6, 2.5, { name="BClockin", heading = 35.0, debugPoly=Config.Debug, minZ = 14.2, maxZ = 15.2, },
				{ options = { { type = "server", event = "QBCore:ToggleDuty", icon = "fas fa-user-check", label = Loc[Config.Lan].targetinfo["toggle_duty"], job = "burgershot" },
							{ event = "qb-bossmenu:client:OpenMenu", icon = "fas fa-list", label = Loc[Config.Lan].targetinfo["open_bossmenu"], job = bossroles, },
							}, distance = 2.0 })
	...
	if Config.MLO == "NP" then
		...
		--Stash/Shops
		Targets["BShelf"] =
		exports['indigo-target']:AddBoxZone("BShelf", vector3(-1197.4, -894.58, 13.98), 1.5, 1.0, { name="BShelf", heading = 34.0, debugPoly=Config.Debug, minZ = 13.78, maxZ = 14.78, },
			{ options = { { event = "jim-burgershot:Stash", icon = "fas fa-box-open", label = Loc[Config.Lan].targetinfo["open_shelves"], job = "burgershot", id = "Shelf" }, },
				distance = 2.0 })
		Targets["BShelf2"] =
		exports['indigo-target']:AddBoxZone("BShelf2", vector3(-1198.26, -893.33, 13.98), 1.5, 1.0, { name="BShelf2", heading = 34.0, debugPoly=Config.Debug, minZ = 13.78, maxZ = 14.78, },
			{ options = { { event = "jim-burgershot:Stash", icon = "fas fa-box-open", label = Loc[Config.Lan].targetinfo["open_shelves"], job = "burgershot", id = "Shelf" }, },
				distance = 2.0 })
		Targets["BFridge"] =
		exports['indigo-target']:AddBoxZone("BFridge", vector3(-1196.71, -901.79, 13.98), 1.6, 0.5, { name="BFridge", heading = 304.0, debugPoly=Config.Debug, minZ = 13.33, maxZ = 15.53, },
			{ options = { { event = "jim-burgershot:Stash", icon = "fas fa-temperature-low", label = Loc[Config.Lan].targetinfo["open_fridge"], job = "burgershot", id = "Fridge" }, },
				distance = 1.5 })
		Targets["BStore"] =
		exports['indigo-target']:AddBoxZone("BStore", vector3(-1205.01, -893.89, 13.98), 2.5, 0.6, { name="BStore", heading = 34.0, debugPoly=Config.Debug, minZ = 12.97, maxZ = 15.37, },
			{ options = { { event = "jim-burgershot:shop", icon = "fas fa-temperature-low", label = Loc[Config.Lan].targetinfo["open_storage"], job = "burgershot" }, },
				distance = 1.5 })
		Targets["BBag"] =
		exports['indigo-target']:AddBoxZone("BBag", vector3(-1197.78, -891.46, 13.98), 2.1, 0.7, { name="BBag", heading = 304.0, debugPoly=Config.Debug, minZ = 13.38, maxZ = 14.38, },
			{ options = { { event = "jim-burgershot:client:GrabBag", icon = "fas fa-bag-shopping", label = Loc[Config.Lan].targetinfo["grab_murderbag"], job = "burgershot", }, },
				distance = 2.0 })
		Targets["BBag2"] =
		exports['indigo-target']:AddBoxZone("BBag2", vector3(-1196.19, -905.02, 13.98), 2.5, 0.7, { name="BBag2", heading = 34.0, debugPoly=Config.Debug, minZ = 13.18, maxZ = 14.78, },
			{ options = { { event = "jim-burgershot:client:GrabBag", icon = "fas fa-bag-shopping", label = Loc[Config.Lan].targetinfo["grab_murderbag"], job = "burgershot", }, },
				distance = 2.0 })

		--Food Makingd
		Targets["BGrill"] =
		exports['indigo-target']:AddBoxZone("BGrill", vector3(-1202.8, -897.25, 13.98), 1.7, 0.7, { name="BGrill", heading = 34.0, debugPoly=Config.Debug, minZ = 13.3, maxZ = 14.5, },
			{ options = { { event = "jim-burgershot:Crafting", icon = "fas fa-fire", label = Loc[Config.Lan].targetinfo["use_grill"], job = "burgershot", craftable = Crafting.Grill, header = Loc[Config.Lan].menu["grill"] }, },
				distance = 1.5 })
		Targets["BFryer"] =
		exports['indigo-target']:AddBoxZone("BFryer", vector3(-1201.85, -898.62, 13.98), 1.7, 0.8, { name="BFryer", heading = 34.0, debugPoly=Config.Debug, minZ = 13.3, maxZ = 14.5, },
			{ options = { { event = "jim-burgershot:Crafting", icon = "fas fa-temperature-high", label = Loc[Config.Lan].targetinfo["use_deepfryer"], job = "burgershot", craftable = Crafting.Fryer, header = Loc[Config.Lan].menu["deep_fat_fryer"] }, },
				distance = 1.5 })
		Targets["BChop"] =
		exports['indigo-target']:AddBoxZone("BChop", vector3(-1198.33, -898.66, 13.98), 1.8, 0.6, { name="BChop", heading = 304.0, debugPoly=Config.Debug, minZ = 13.78, maxZ = 14.38, },
			{ options = { { event = "jim-burgershot:Crafting", icon = "fas fa-utensils", label = Loc[Config.Lan].targetinfo["use_chopping_board"], job = "burgershot", craftable = Crafting.ChopBoard, Loc[Config.Lan].menu["chopping_board"] }, },
				distance = 1.5 })
		Targets["BPrepare"] =
		exports['indigo-target']:AddBoxZone("BPrepare", vector3(-1199.62, -897.78, 13.98), 1.7, 0.6, { name="BPrepare", heading = 34.0, debugPoly=Config.Debug, minZ = 13.78, maxZ = 14.38, },
			{ options = { { event = "jim-burgershot:Crafting", icon = "fas fa-hamburger", label = Loc[Config.Lan].targetinfo["prepare_food"], job = "burgershot", craftable = Crafting.Prepare, Loc[Config.Lan].menu["prepare_food"] }, },
				distance = 1.5 })
		Targets["BDrink"] =
		exports['indigo-target']:AddBoxZone("BDrink", vector3(-1199.85, -895.35, 13.98), 2.35, 0.6, { name="BDrink", heading = 34.0, debugPoly=Config.Debug, minZ = 13.78, maxZ = 14.78, },
			{ options = { { event = "jim-burgershot:Crafting", icon = "fas fa-mug-hot", label = Loc[Config.Lan].targetinfo["prepare_drinks"], job = "burgershot", craftable = Crafting.Drink, header = Loc[Config.Lan].menu["drinks_dispenser"] }, },
				distance = 1.5 })
		Targets["BDrink2"] =
		exports['indigo-target']:AddBoxZone("BDrink2", vector3(-1190.07, -904.51, 13.98), 2.35, 0.6, { name="BDrink2", heading = 34.0, debugPoly=Config.Debug, minZ = 13.78, maxZ = 14.78, },
			{ options = { { event = "jim-burgershot:Crafting", icon = "fas fa-mug-hot", label = Loc[Config.Lan].targetinfo["prepare_drinks"], job = "burgershot", craftable = Crafting.Drink, header = Loc[Config.Lan].menu["drinks_dispenser"] }, },
				distance = 1.5 })
		Targets["BDonut"] =
		exports['indigo-target']:AddBoxZone("BDonut", vector3(-1203.45, -895.67, 13.98),1.5, 0.5, { name="BDonut", heading = 34.0, debugPoly=Config.Debug, minZ = 13.97, maxZ = 15.17, },
		...
		--Trays
		Targets["BTray1"] =
		exports['indigo-target']:AddBoxZone("BTray1", vector3(-1195.88, -891.31, 14.2), 0.6, 1.0, { name="BTray1", heading = 215.0, debugPoly=Config.Debug, minZ = 14.0, maxZ = 15.35, },
			{ options = { { event = "jim-burgershot:Stash", icon = "fas fa-hamburger", label = Loc[Config.Lan].targetinfo["open_tray"], id = "Tray1" }, },
				distance = 2.0 })
		Targets["BTray2"] =
		exports['indigo-target']:AddBoxZone("BTray2", vector3(-1194.99, -892.92, 14.2), 0.6, 1.1, { name="BTray2", heading = 215.0, debugPoly=Config.Debug, minZ = 14.0, maxZ = 15.35, },
			{ options = { { event = "jim-burgershot:Stash", icon = "fas fa-hamburger", label = Loc[Config.Lan].targetinfo["open_tray"], id = "Tray2" }, },
				distance = 2.0 })
		Targets["BTray3"] =
		exports['indigo-target']:AddBoxZone("BTray3", vector3(-1193.88, -894.37, 14.2), 0.6, 1.0, { name="BTray3", heading = 215.0, debugPoly=Config.Debug, minZ = 14.0, maxZ = 15.35, },
			{ options = { { event = "jim-burgershot:Stash", icon = "fas fa-hamburger", label = Loc[Config.Lan].targetinfo["open_tray"], id = "Tray3" }, },
				distance = 2.0 })

		--Hand Washing
		Targets["BWash1"] =
		exports['indigo-target']:AddBoxZone("BWash1", vector3(-1199.41, -886.27, 13.98), 0.6, 0.6, { name="BWash1", heading = 305.0, debugPoly=Config.Debug, minZ = 13.18, maxZ = 14.38, },
			{ options = { { event = "jim-burgershot:washHands", icon = "fas fa-hand-holding-water", label = Loc[Config.Lan].targetinfo["wash_hands"], }, },
				distance = 2.0 })
		Targets["BWash2"] =
		exports['indigo-target']:AddBoxZone("BWash2", vector3(-1201.92, -887.98, 13.98), 0.6, 0.6, { name="BWash2", heading = 305.0, debugPoly=Config.Debug, minZ = 13.18, maxZ = 14.38, },
			{ options = { { event = "jim-burgershot:washHands", icon = "fas fa-hand-holding-water", label = Loc[Config.Lan].targetinfo["wash_hands"], }, },
				distance = 2.0 })
		Targets["BWash3"] =
		exports['indigo-target']:AddBoxZone("BWash3", vector3(-1200.24, -901.13, 13.88), 0.8, 0.85, { name="BWash3", heading = 34.0, debugPoly=Config.Debug, minZ = 13.38, maxZ = 14.38, },
			{ options = { { event = "jim-burgershot:washHands", icon = "fas fa-hand-holding-water", label = Loc[Config.Lan].targetinfo["wash_hands"], }, },
				distance = 2.0 })
		Targets["BWash4"] =
		exports['indigo-target']:AddBoxZone("BWash4", vector3(-1191.73, -901.48, 13.98), 0.82, 0.75, { name="BWash4", heading = 34.0, debugPoly=Config.Debug, minZ = 13.38, maxZ = 14.38, },
			{ options = { { event = "jim-burgershot:washHands", icon = "fas fa-hand-holding-water", label = Loc[Config.Lan].targetinfo["wash_hands"], }, },
				distance = 2.0 })
		Targets["BWash5"] =
		exports['indigo-target']:AddBoxZone("BWash5", vector3(-1181.53, -899.43, 13.98), 0.82, 0.75, { name="BWash5", heading = 34.0, debugPoly=Config.Debug, minZ = 13.18, maxZ = 14.38, },
			{ options = { { event = "jim-burgershot:washHands", icon = "fas fa-hand-holding-water", label = Loc[Config.Lan].targetinfo["wash_hands"], }, },
				distance = 2.0 })

		--Payments / Clockin
		Targets["BReceipt"] =
		exports['indigo-target']:AddBoxZone("BReceipt", vector3(-1194.23, -893.87, 13.98), 0.35, 1.0, { name="BReceipt", heading = 35.0, debugPoly=Config.Debug, minZ = 13.98, maxZ = 14.58, },
			{ options = { { event = "jim-payments:client:Charge", icon = "fas fa-credit-card", label = Loc[Config.Lan].targetinfo["charge_customer"], job = "burgershot",
							img = "<center><p><img src=https://static.wikia.nocookie.net/gtawiki/images/b/bf/BurgerShot-HDLogo.svg width=225px></p>" }, },
				distance = 1.5 })

		Targets["BReceipt2"] =
		exports['indigo-target']:AddBoxZone("BReceipt2", vector3(-1195.28, -892.35, 13.98), 0.35, 1.0, { name="BReceipt2", heading = 35.0, debugPoly=Config.Debug, minZ = 13.98, maxZ = 14.58, },
			{ options = { { event = "jim-payments:client:Charge", icon = "fas fa-credit-card", label = Loc[Config.Lan].targetinfo["charge_customer"], job = "burgershot",
							img = "<center><p><img src=https://static.wikia.nocookie.net/gtawiki/images/b/bf/BurgerShot-HDLogo.svg width=225px></p>" }, },
				distance = 1.5 })
		Targets["BReceipt3"] =
		exports['indigo-target']:AddBoxZone("BReceipt3", vector3(-1196.29, -890.82, 13.98), 0.55, 1.0, { name="BReceipt3", heading = 35.0, debugPoly=Config.Debug, minZ = 13.98, maxZ = 14.58, },
			{ options = { { event = "jim-payments:client:Charge", icon = "fas fa-credit-card", label = Loc[Config.Lan].targetinfo["charge_customer"], job = "burgershot",
							img = "<center><p><img src=https://static.wikia.nocookie.net/gtawiki/images/b/bf/BurgerShot-HDLogo.svg width=225px></p>" }, },
				distance = 1.5 })
		Targets["BReceipt4"] =
		exports['indigo-target']:AddBoxZone("BReceipt4", vector3(-1192.74, -906.44, 13.98), 0.55, 1.0, { name="BReceipt4", heading = 324.0, debugPoly=Config.Debug, minZ = 13.98, maxZ = 14.58, },
			{ options = { { event = "jim-payments:client:Charge", icon = "fas fa-credit-card", label = Loc[Config.Lan].targetinfo["charge_customer"], job = "burgershot",
							img = "<center><p><img src=https://static.wikia.nocookie.net/gtawiki/images/b/bf/BurgerShot-HDLogo.svg width=225px></p>" }, },
				distance = 1.5 })

		Targets["BClockin"] =
		exports['indigo-target']:AddBoxZone("BClockin", vector3(-1191.52, -900.58, 13.98), 1.4, 0.2, { name="BClockin", heading = 34.0, debugPoly=Config.Debug, minZ = 14.18, maxZ = 15.38, },
				{ options = { { type = "server", event = "QBCore:ToggleDuty", icon = "fas fa-user-check", label = Loc[Config.Lan].targetinfo["toggle_duty"], job = "burgershot" },
							}, distance = 2.0 })
		Targets["BClockin2"] =
		exports['indigo-target']:AddBoxZone("BClockin2", vector3(-1178.11, -896.3, 13.98), 0.8, 0.5, { name="BClockin2", heading = 34.0, debugPoly=Config.Debug, minZ = 13.78, maxZ = 14.58, },
...
RegisterNetEvent('jim-burgershot:Stash', function(data, id)
	if id then -- If it has a bag ID then open the limited stash
		TriggerServerEvent("inventory:server:OpenInventory", "stash", "burgershot_"..id, { maxweight = 12000, slots = 10, })
