...
local function busGarage()
    ...
    for _, v in pairs(Config.AllowedVehicles) do
        vehicleMenu[#vehicleMenu + 1] = {
            header = v.label,
            params = {
                event = "indigo-busjob:client:TakeVehicle",
                args = {
                    model = v.model
                }
            }
...
RegisterNetEvent("indigo-busjob:client:TakeVehicle", function(data)
...
RegisterNetEvent('indigo-busjob:client:DoBusNpc', function()
