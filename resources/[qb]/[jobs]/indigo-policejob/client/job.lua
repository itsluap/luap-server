...
function stash()
    CreateThread(function()
        while true do
            Wait(0)
            if inStash and GlobalState.isLEO then
...
function trash()
    CreateThread(function()
        while true do
            Wait(0)
            if inTrash and GlobalState.isLEO then
                if onDuty then sleep = 5 end
                if IsControlJustReleased(0, 38) then
...
function fingerprint()
    CreateThread(function()
        while true do
            Wait(0)
            if inFingerprint and GlobalState.isLEO then
                if onDuty then sleep = 5 end
                if IsControlJustReleased(0, 38) then
...
function heli()
    CreateThread(function()
        while true do
            Wait(0)
            if inHelicopter and GlobalState.isLEO then
                if onDuty then sleep = 5 end
                if IsControlJustReleased(0, 38) then
...
function impound()
    CreateThread(function()
        while true do
            Wait(0)
            if inImpound and GlobalState.isLEO then
                if onDuty then sleep = 5 end
                if IsPedInAnyVehicle(PlayerPedId(), false) then
                    if IsControlJustReleased(0, 38) then
                        QBCore.Functions.DeleteVehicle(GetVehiclePedIsIn(PlayerPedId()))
...
function garage()
    CreateThread(function()
        while true do
            Wait(0)
            if inGarage and GlobalState.isLEO then
                if onDuty then sleep = 5 end
                if IsPedInAnyVehicle(PlayerPedId(), false) then
                    if IsControlJustReleased(0, 38) then
                        QBCore.Functions.DeleteVehicle(GetVehiclePedIsIn(PlayerPedId()))
