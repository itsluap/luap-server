            ...
            for i=1, #GroupMembers do
                CreateThread(function ()
                    if Config.Phone == 'qb' then
                        TriggerClientEvent('qb-phone:client:CustomNotification', GroupMembers[i], Config.PhoneNotification1Title, Config.PhoneNotification1, Config.PhoneNotification1Icon, Config.PhoneNotification1TextColour, 15000)
...
RegisterNetEvent('kevin-deliveries:DeliverPackage', function (GroupID)
    ...
    if Package then
        ...
        for i=1, #GroupMembers do
            CreateThread(function ()
                if Config.Phone == 'qb' then
                    TriggerClientEvent('qb-phone:client:CustomNotification', GroupMembers[i], Config.PhoneNotification2Title, Config.PhoneNotification2..Jobs[jobID]['DeliveredPackages']..' / '..Jobs[jobID]['DeliveryPackages'], Config.PhoneNotification2Icon, Config.PhoneNotification2TextColour, 15000)
                elseif Config.Phone == 'gks' then
        ...
        if Jobs[jobID]['DeliveredPackages'] ==  Jobs[jobID]['DeliveryPackages'] then
            for i=1, #GroupMembers do
                ...
                CreateThread(function ()
                    if Config.Phone == 'qb' then
                        TriggerClientEvent('qb-phone:client:CustomNotification', GroupMembers[i], Config.PhoneNotification3Title, Config.PhoneNotification3, Config.PhoneNotification3Icon, Config.PhoneNotification3TextColour, 15000)
                        Wait(3500)
                        TriggerClientEvent('qb-phone:client:CustomNotification', GroupMembers[i], Config.PhoneNotification4Title, Config.PhoneNotification4, Config.PhoneNotification4Icon, Config.PhoneNotification4TextColour, 15000)
                    elseif Config.Phone == 'gks' then
...
RegisterNetEvent('kevin-deliveries:SendEndMessages', function (GroupID)
    ...
    for i=1, #GroupMembers do
        CreateThread(function ()
            if Config.Phone == 'qb' then
                TriggerClientEvent('qb-phone:client:CustomNotification', GroupMembers[i], Config.PhoneNotification5Title, Config.PhoneNotification5, Config.PhoneNotification5Icon, Config.PhoneNotification5TextColour, 15000)
                Wait(3500)
                TriggerClientEvent('qb-phone:client:CustomNotification', GroupMembers[i], Config.PhoneNotification6Title, Config.PhoneNotification6, Config.PhoneNotification6Icon, Config.PhoneNotification6TextColour, 15000)
            elseif Config.Phone == 'gks' then
