...
Config.Locations = {
    ...
    {	job = "autoex",
		...
		stash = { { coords = vector3(547.81, -184.71, 55.52), w = 0.6, d = 3.6, heading = 90.0 }, },
		store = { { coords = vector3(547.74, -181.69, 55.54), w = 1.0, d = 1.4, heading = 90.0 }, },
		...
		garage = { spawn = vector4(542.54, -223.95, 50.98, 137.42),
					...
					list = { "towtruck", "panto", "slamtruck", "cheburek", "utillitruck3" } },
		payments = { coords = vector3(545.13, -196.06, 55.68), heading = 0.35, img = "<center><p><img src=https://i.imgur.com/74UVnCb.jpeg width=150px></p>" },
		blip = vector3(831.03, -813.01, 26.33),
