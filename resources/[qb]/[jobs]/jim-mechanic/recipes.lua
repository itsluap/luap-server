Crafting = {
	Tools = {
		{ ['mechanic_tools'] = { ['iron'] = 4, } },
		{ ['toolbox'] = { ['iron'] = 4, } },
		{ ['ducttape'] = { ['plastic'] = 2, } },
		{ ['paintcan'] = { ['aluminum'] = 2, } },
		{ ['tint_supplies'] = { ['iron'] = 2, } },
		{ ['underglow_controller'] = { ['iron'] = 4, } },
		{ ['cleaningkit'] = { ['rubber'] = 2, } },
...
Stores = {
	ToolItems = {
		...
		items = {
			{ name = "mechanic_tools", price = 200, amount = 10, info = {}, type = "item", },
			{ name = "toolbox", price = 200, amount = 10, info = {}, type = "item", },
			{ name = "ducttape", price = 200, amount = 100, info = {}, type = "item", },
			{ name = "paintcan", price = 200, amount = 50, info = {}, type = "item", },
			{ name = "tint_supplies", price = 200, amount = 50, info = {}, type = "item", },
			{ name = "underglow_controller", price = 200, amount = 50, info = {}, type = "item", },
			{ name = "cleaningkit", price = 200, amount = 100, info = {}, type = "item", },
		},
	},
	PerformItems = {
		label = Loc[Config.Lan]["stores"].perform,
		items = {
			{ name = "turbo", price = 200, amount = 50, info = {}, type = "item", },
			{ name = "engine1", price = 200, amount = 50, info = {}, type = "item", },
			{ name = "engine2", price = 200, amount = 50, info = {}, type = "item", },
			{ name = "engine3", price = 200, amount = 50, info = {}, type = "item", },
			{ name = "engine4", price = 200, amount = 50, info = {}, type = "item", },
			{ name = "transmission1", price = 200, amount = 50, info = {}, type = "item", },
			{ name = "transmission2", price = 200, amount = 50, info = {}, type = "item", },
			{ name = "transmission3", price = 200, amount = 50, info = {}, type = "item", },
			{ name = "brakes1", price = 200, amount = 50, info = {}, type = "item", },
			{ name = "brakes2", price = 200, amount = 50, info = {}, type = "item", },
			{ name = "brakes3", price = 200, amount = 50, info = {}, type = "item", },
			{ name = "car_armor", price = 200, amount = 50, info = {}, type = "item", },
			{ name = "suspension1", price = 200, amount = 50, info = {}, type = "item", },
			{ name = "suspension2", price = 200, amount = 50, info = {}, type = "item", },
			{ name = "suspension3", price = 200, amount = 50, info = {}, type = "item", },
			{ name = "suspension4", price = 200, amount = 50, info = {}, type = "item", },
			{ name = "bprooftires", price = 200, amount = 50, info = {}, type = "item", },
			{ name = "drifttires", price = 200, amount = 50, info = {}, type = "item", },
			{ name = "nos", price = 200, amount = 50, info = {}, type = "item", },
		},
	},
	StoreItems = {
