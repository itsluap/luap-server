...
RegisterNetEvent('indigo-scrapyard:server:LoadVehicleList', function()
    local src = source
    TriggerClientEvent("qb-scapyard:client:setNewVehicles", src, Config.CurrentVehicles)
end)


QBCore.Functions.CreateCallback('indigo-scrapyard:checkOwnerVehicle', function(_, cb, plate)
...
RegisterNetEvent('indigo-scrapyard:server:ScrapVehicle', function(listKey)
    local src = source
