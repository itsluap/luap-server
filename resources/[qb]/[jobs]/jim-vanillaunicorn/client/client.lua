...
CreateThread(function()
	...
	if Config.MLO == "gabz" then
		Targets["UniPrepared"] =
		exports['indigo-target']:AddBoxZone("UniPrepared", vector3(136.13, -1287.12, 29.27), 1.7, 0.8, { name="UniPrepared", heading = 30.0, debugPoly=Config.Debug, minZ = 28.37, maxZ = 29.97, },
			{ options = { {  event = "jim-vanillaunicorn:Stash", icon = "fas fa-box-open", label = "Prepared Food", stash = "Storage", job = "vanilla" }, }, distance = 1.0 })

		Targets["UniFridge"] =
		exports['indigo-target']:AddBoxZone("UniFridge", vector3(129.95, -1280.65, 29.27), 1.5, 0.6, { name="UniFridge", heading = 30.0, debugPoly=Config.Debug, minZ=28.22, maxZ=29.22 },
			{ options = { {  event = "jim-vanillaunicorn:Shop", icon = "fas fa-archive", label = Loc[Config.Lan].targetinfo["open_drink_fridge"], job = "vanilla", shop = Config.DrinkItems }, }, distance = 1.5 })
		Targets["UniFridge2"] =
		exports['indigo-target']:AddBoxZone("UniFridge2", vector3(128.84, -1284.25, 29.27), 1.5, 0.6, { name="UniFridge2", heading = 30.0, debugPoly=Config.Debug, minZ=28.27, maxZ=29.27 },
			{ options = { {  event = "jim-vanillaunicorn:Shop", icon = "fas fa-archive", label = Loc[Config.Lan].targetinfo["open_drink_fridge"], job = "vanilla", shop = Config.DrinkItems }, }, distance = 1.5 })
		Targets["UniFridge3"] =
		exports['indigo-target']:AddBoxZone("UniFridge3", vector3(129.74, -1285.53, 29.27), 0.8, 0.4, { name="UniFridge3", heading = 30.0, debugPoly=Config.Debug, minZ=28.27, maxZ=29.27 },
			{ options = { {  event = "jim-vanillaunicorn:Shop", icon = "fas fa-archive", label = Loc[Config.Lan].targetinfo["open_drink_fridge"], job = "vanilla", shop = Config.DrinkItems }, }, distance = 1.5 })
		Targets["UniFridge4"] =
		exports['indigo-target']:AddBoxZone("UniFridge4", vector3(132.66, -1285.43, 29.27), 1.2, 0.6, { name="UniFridge4", heading = 30.0, debugPoly=Config.Debug, minZ=28.27, maxZ=29.27 },
			{ options = { {  event = "jim-vanillaunicorn:Shop", icon = "fas fa-archive", label = Loc[Config.Lan].targetinfo["open_drink_fridge"], job = "vanilla", shop = Config.DrinkItems }, }, distance = 1.5 })
		Targets["UniFridge5"] =
		exports['indigo-target']:AddBoxZone("UniFridge5", vector3(119.23, -1302.93, 29.27), 1.4, 0.6, { name="UniFridge5", heading = 300.0, debugPoly=Config.Debug, minZ=28.27, maxZ=29.27 },
			{ options = { {  event = "jim-vanillaunicorn:Shop", icon = "fas fa-archive", label = Loc[Config.Lan].targetinfo["open_drink_fridge"], job = "vanilla", shop = Config.DrinkItems }, }, distance = 1.5 })
		Targets["UniFridge6"] =
		exports['indigo-target']:AddBoxZone("UniFridge6", vector3(132.32, -1291.67, 29.27), 0.8, 0.6, { name="UniFridge6", heading = 30.0, debugPoly=Config.Debug, minZ = 28.27, maxZ = 30.07, },
			{ options = { {  event = "jim-vanillaunicorn:Shop", icon = "fas fa-archive", label = Loc[Config.Lan].targetinfo["open_food_fridge"],"Open Food Fridge", job = "vanilla", shop = Config.FoodItems }, }, distance = 2.0 })

		Targets["UniWash1"] =
		exports['indigo-target']:AddBoxZone("UniWash1", vector3(136.45, -1289.37, 29.27), 0.8, 0.8, { name="UniWash1", heading = 30.0, debugPoly=Config.Debug, minZ = 28.47, maxZ = 29.87, },
			{ options = { { event = "jim-vanillaunicorn:washHands", icon = "fas fa-hand-holding-water", label = Loc[Config.Lan].targetinfo["wash_hands"], job = "vanilla" }, }, distance = 1.5	})
		Targets["UniWash2"] =
		exports['indigo-target']:AddBoxZone("UniWash2", vector3(130.28, -1286.21, 29.27), 0.8, 0.6, { name="UniWash2", heading = 30.0, debugPoly=Config.Debug, minZ = 28.67, maxZ = 29.87, },
		...
		Targets["UniCounter"] =
		exports['indigo-target']:AddBoxZone("UniCounter", vector3(128.63, -1284.3, 29.27), 1.1, 1.0, { name="UniCounter", heading = 30.0, debugPoly=Config.Debug, minZ = 29.27, maxZ = 30.07, },
			{ options = { { event = "jim-vanillaunicorn:Stash", icon = "fas fa-hamburger", label = Loc[Config.Lan].targetinfo["open_counter"], stash = "Counter" }, }, distance = 2.0 })

		Targets["UniReceipt"] =
		exports['indigo-target']:AddBoxZone("UniReceipt", vector3(129.19, -1284.95, 29.27), 0.6, 0.6, { name="UniReceipt", heading = 30.0, debugPoly=Config.Debug, minZ = 29.27, maxZ = 30.07, },
			{ options = { { event = "jim-payments:client:Charge", icon = "fas fa-credit-card", label = Loc[Config.Lan].targetinfo["charge_customer"], job = "vanilla",
							img = "<center><p><img src=https://static.wikia.nocookie.net/gtawiki/images/1/10/VanillaUnicorn-GTAV-Logo.png/ width=225px></p>"
							} }, distance = 2.0 })
		Targets["UniReceipt2"] =
		exports['indigo-target']:AddBoxZone("UniReceipt2", vector3(133.0, -1286.0, 29.27), 0.6, 0.6, { name="UniReceipt2", heading = 30.0, debugPoly=Config.Debug, minZ = 29.27, maxZ = 30.07, },
			{ options = { { event = "jim-payments:client:Charge", icon = "fas fa-credit-card", label = Loc[Config.Lan].targetinfo["charge_customer"], job = "vanilla",
							img = "<center><p><img src=https://static.wikia.nocookie.net/gtawiki/images/1/10/VanillaUnicorn-GTAV-Logo.png/ width=225px></p>"
							} }, distance = 2.0 })
		Targets["UniReceipt3"] =
		exports['indigo-target']:AddBoxZone("UniReceipt3", vector3(118.96, -1303.18, 29.27), 0.6, 0.6, { name="UniReceipt3", heading = 30.0, debugPoly=Config.Debug, minZ = 29.07, maxZ = 29.87, },
			{ options = { { event = "jim-payments:client:Charge", icon = "fas fa-credit-card", label = Loc[Config.Lan].targetinfo["charge_customer"], job = "vanilla",
							img = "<center><p><img src=https://static.wikia.nocookie.net/gtawiki/images/1/10/VanillaUnicorn-GTAV-Logo.png/ width=225px></p>"
							} }, distance = 2.0 })

		Targets["UniCocktails"] =
		exports['indigo-target']:AddBoxZone("UniCocktails", vector3(130.3, -1281.51, 29.27), 0.6, 0.6, { name="UniCocktails", heading = 30.0, debugPoly=Config.Debug, minZ=28.87, maxZ=29.87 },
			{ options = { { event = "jim-vanillaunicorn:Crafting", icon = "fas fa-cocktail", label = Loc[Config.Lan].targetinfo["prepare_cocktails"], job = "vanilla", craftable = Crafting.Cocktails, header = Loc[Config.Lan].menu["cocktail"] }, }, distance = 2.0 })

		Targets["UniTap"] =
		exports['indigo-target']:AddBoxZone("UniTap", vector3(128.0, -1283.14, 29.27), 0.6, 0.5, { name="UniTap", heading = 30.0, debugPoly=Config.Debug, minZ = 29.27, maxZ = 29.87, },
			{ options = { { event = "jim-vanillaunicorn:Crafting", icon = "fas fa-beer", label = Loc[Config.Lan].targetinfo["pour_beer"], job = "vanilla", craftable = Crafting.Beer, header = Loc[Config.Lan].menu["beer"] }, }, distance = 1.5 })

		Targets["UniCoffee"] =
		exports['indigo-target']:AddBoxZone("UniCoffee", vector3(131.53, -1282.96, 29.27), 0.5, 0.5, { name="UniCoffee", heading = 30.0, debugPoly=Config.Debug, minZ = 28.87, maxZ = 30.07, },
			{ options = { { event = "jim-vanillaunicorn:JustGive", icon = "fas fa-mug-hot", label = Loc[Config.Lan].targetinfo["pour_coffee"], job = "vanilla", id = "coffee"}, }, distance = 2.0 })

		Targets["UniClockin"] =
		exports['indigo-target']:AddBoxZone("UniClockin", vector3(102.19, -1299.53, 28.77), 0.8, 0.3, { name="UniClockin", heading = 30.0, debugPoly=Config.Debug, minZ = 28.0, maxZ = 32.0, },
			{ options = { { type = "server", event = "QBCore:ToggleDuty", icon = "fas fa-user-check", label = Loc[Config.Lan].targetinfo["toggle_duty"], job = "vanilla" }, }, distance = 2.0 })

		Targets["UniBoss"] =
		exports['indigo-target']:AddBoxZone("UniBoss", vector3(96.19, -1292.77, 29.26), 0.6, 0.6, { name="UniBoss", heading = 45.0, debugPoly=Config.Debug, minZ = 28.0, maxZ = 32.0, },
		...
		Targets["UniOven"] =
		exports['indigo-target']:AddBoxZone("UniOven", vector3(134.24, -1290.51, 29.27), 0.6, 0.5, { name="UniOven", heading = 300.0, debugPoly=Config.Debug, minZ = 28.97, maxZ = 30.07, },
			{ options = { { event = "jim-vanillaunicorn:Crafting", icon = "fas fa-temperature-high", label = Loc[Config.Lan].targetinfo["use_oven"], job = "vanilla", craftable = Crafting.Food, header = Loc[Config.Lan].menu["oven"] }, }, distance = 2.0 })
	...
	elseif Config.MLO == "van" then
		Targets["UniDoor"] =
		exports['indigo-target']:AddBoxZone("UniDoor", vector3(138.12, -1292.51, 29.23), 0.6, 2.6, { name="UniDoor", heading = 30.0, debugPoly=Config.Debug, minZ = 28.23, maxZ = 31.03, },
			{ options = { { event = "jim-vanillaunicorn:Door", icon = "fas fa-door-open", label = Loc[Config.Lan].targetinfo["bar_access"],"Bar Access", job = "vanilla", door = 1 }, }, distance = 2.0	})
		Targets["UniDoor2"] =
		exports['indigo-target']:AddBoxZone("UniDoor2", vector3(132.83, -1288.03, 29.27), 0.6, 1.4, { name="UniDoor2", heading = 30.0, debugPoly=Config.Debug, minZ = 28.27, maxZ = 30.57, },
			{ options = { { event = "jim-vanillaunicorn:Door", icon = "fas fa-door-open", label = Loc[Config.Lan].targetinfo["bar_exit"],"Bar Exit", job = "vanilla", door = 2 }, }, distance = 2.0 })

		Targets["UniWash1"] =
		exports['indigo-target']:AddBoxZone("UniWash1", vector3(130.4, -1286.45, 29.28), 0.8, 0.6, { name="UniWash1", heading = 30.0, debugPoly=Config.Debug, minZ = 28.68, maxZ = 29.28, },
			{ options = { { event = "jim-vanillaunicorn:washHands", icon = "fas fa-hand-holding-water", label = Loc[Config.Lan].targetinfo["wash_hands"], job = "vanilla" }, }, distance = 1.5 })

		Targets["UniFridge"] =
		exports['indigo-target']:AddBoxZone("UniFridge", vector3(128.89, -1284.18, 29.28), 3.8, 0.5, { name="UniFridge", heading = 30.0, debugPoly=Config.Debug, minZ=28.28, maxZ=29.27 },
			{ options = { {  event = "jim-vanillaunicorn:Shop", icon = "fas fa-archive", label = Loc[Config.Lan].targetinfo["open_drink_fridge"], shop = 1, job = "vanilla", shop = Config.DrinkItems }, }, distance = 1.5 })
		Targets["UniFridge2"] =
		exports['indigo-target']:AddBoxZone("UniFridge2", vector3(129.72, -1280.61, 29.27), 2.85, 0.5, { name="UniFridge2", heading = 30.0, debugPoly=Config.Debug, minZ=28.27, maxZ=29.27 },
			{ options = { {  event = "jim-vanillaunicorn:Shop", icon = "fas fa-archive", label = Loc[Config.Lan].targetinfo["open_drink_fridge"], shop = 1, job = "vanilla", shop = Config.DrinkItems }, }, distance = 1.5 })
		Targets["UniFridge3"] =
		exports['indigo-target']:AddBoxZone("UniFridge3", vector3(132.31, -1285.06, 29.27), 3.6, 0.5, { name="UniFridge3", heading = 30.0, debugPoly=Config.Debug, minZ=28.27, maxZ=29.27 },
			{ options = { {  event = "jim-vanillaunicorn:Shop", icon = "fas fa-archive", label = Loc[Config.Lan].targetinfo["open_drink_fridge"], shop = 1, job = "vanilla", shop = Config.DrinkItems }, }, distance = 1.5 })
		Targets["UniFridge4"] =
		exports['indigo-target']:AddBoxZone("UniFridge4", vector3(129.35, -1279.92, 29.27), 0.75, 0.6, { name="UniFridge4", heading = 50.0, debugPoly=Config.Debug, minZ = 29.47, maxZ = 30.47, },
		...
		Targets["UniReceipt"] =
		exports['indigo-target']:AddBoxZone("UniReceipt", vector3(129.26, -1285.01, 29.27), 0.6, 0.6, { name="UniReceipt", heading = 30.0, debugPoly=Config.Debug, minZ = 29.27, maxZ = 30.07, },
			{ options = { { event = "jim-payments:client:Charge", icon = "fas fa-credit-card", label = Loc[Config.Lan].targetinfo["charge_customer"], job = "vanilla",
							img = "<center><p><img src=https://static.wikia.nocookie.net/gtawiki/images/1/10/VanillaUnicorn-GTAV-Logo.png/ width=225px></p>"
							} }, distance = 2.0 })

		Targets["UniCounter"] =
		exports['indigo-target']:AddBoxZone("UniCounter", vector3(128.15, -1283.48, 29.27), 0.8, 1.1, { name="UniCounter", heading = 30.0, debugPoly=Config.Debug, minZ = 29.07, maxZ = 29.87, },
			{ options = { { event = "jim-vanillaunicorn:Stash", icon = "fas fa-hamburger", label = Loc[Config.Lan].targetinfo["open_counter"],"Open Counter", stash = "Counter" }, }, distance = 2.5 })

		Targets["UniCocktails"] =
		exports['indigo-target']:AddBoxZone("UniCocktails", vector3(130.97, -1282.68, 29.27), 0.55, 0.4, { name="UniCocktails", heading = 30.0, debugPoly=Config.Debug, minZ= 29.27, maxZ= 29.87 },
			{ options = { { event = "jim-vanillaunicorn:Crafting", icon = "fas fa-cocktail", label = Loc[Config.Lan].targetinfo["prepare_cocktails"], job = "vanilla", craftable = Crafting.Cocktails, header = Loc[Config.Lan].menu["cocktail"] }, }, distance = 2.0 })

		Targets["UniCoffee"] =
		exports['indigo-target']:AddBoxZone("UniCoffee", vector3(130.86, -1281.61, 29.27), 0.4, 0.6, { name="UniCoffee", heading = 30.0, debugPoly=Config.Debug, minZ = 29.27, maxZ = 30.07, },
			{ options = { { event = "jim-vanillaunicorn:JustGive", icon = "fas fa-mug-hot", label = Loc[Config.Lan].targetinfo["pour_coffee"], job = "vanilla", id = "coffee"}, }, distance = 2.0 })

		Targets["UniOven"] =
		exports['indigo-target']:AddBoxZone("UniOven", vector3(133.22, -1286.38, 29.27), 0.4, 0.8, { name="UniOven", heading = 300.0, debugPoly=Config.Debug, minZ = 29.27, maxZ = 29.87, },
			{ options = { { event = "jim-vanillaunicorn:Crafting", icon = "fas fa-temperature-high", label = Loc[Config.Lan].targetinfo["use_oven"], job = "vanilla", craftable = Crafting.Food, header = Loc[Config.Lan].menu["oven"] }, }, distance = 2.0 })

		Targets["UniTap"] =
		exports['indigo-target']:AddBoxZone("UniTap", vector3(128.08, -1282.65, 29.27), 0.2, 0.3, { name="UniTap", heading = 30.0, debugPoly=Config.Debug, minZ = 29.27, maxZ = 29.87, },
			{ options = { { event = "jim-vanillaunicorn:Crafting", icon = "fas fa-beer", label = Loc[Config.Lan].targetinfo["pour_beer"], job = "vanilla", craftable = Crafting.Beer, header = Loc[Config.Lan].menu["beer"] }, }, distance = 1.5 })
	...
	for i = 1, #Config.Locations do
		if Config.Locations[i].Booth.enableBooth then
			Targets["UniBooth"..i] =
			exports['indigo-target']:AddCircleZone("UniBooth"..i, Config.Locations[i].Booth.coords, 0.75, {name="UniBooth"..i, debugPoly=Config.Debug, useZ=true, },
				{ options = { { event = "jim-vanillaunicorn:client:playMusic", icon = "fab fa-youtube", label = Loc[Config.Lan].targetinfo["dj_booth"], job = "vanilla", zone = i, }, }, distance = 2.0 })
		end
	end
end)
	...
	for i = 1, #data.craftable do
		for k, v in pairs(data.craftable[i]) do
			if k ~= "amount" then
				...
				Menu[#Menu + 1] = { disabled = disable, icon = k, header = setheader, txt = settext, params = { event = "jim-vanillaunicorn:Crafting:MakeItem", args = { item = k, craft = data.craftable[i], craftable = data.craftable, header = data.header } } }
...
exports['indigo-target']:AddBoxZone("stripEffects", vector3(121.55, -1282.97, 29.48), 0.2, 0.2, {
	name = "stripEffects",
	heading = 30.0,
	debugPoly = false,
	minZ = 29.58,
