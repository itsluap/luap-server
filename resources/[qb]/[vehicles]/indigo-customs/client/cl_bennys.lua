...
local function saveVehicle()
    ...
    TriggerServerEvent('indigo-customs:server:updateVehicle', myCar)
end
...
function AttemptPurchase(type, upgradeLevel)
    ...
    TriggerServerEvent("indigo-customs:server:attemptPurchase", type, upgradeLevel, CustomsData.location)
...
function GetLocations()
    QBCore.Functions.TriggerCallback("indigo-customs:server:GetLocations", function(locations)
            ...
            if Config.UseRadial then
                if not radialMenuItemId then
                    radialMenuItemId = exports['indigo-radialmenu']:AddOption({
                        ...
                        icon = 'wrench',
                        type = 'client',
                        event = 'indigo-customs:client:EnterCustoms',
                        shouldClose = true
                    })
                end
            else
...
RegisterNetEvent('indigo-customs:client:UpdateLocation', function(location, type, key, value)
    Config.Locations[location][type][key] = value
end)

RegisterNetEvent("indigo-customs:client:purchaseSuccessful", function()
    isPurchaseSuccessful = true
    attemptingPurchase = false
    QBCore.Functions.Notify("Purchase Successful")
end)

RegisterNetEvent("indigo-customs:client:purchaseFailed", function()
    isPurchaseSuccessful = false
    attemptingPurchase = false
    QBCore.Functions.Notify("Not enough money", "error")
end)

RegisterNetEvent('indigo-customs:client:EnterCustoms', function(override)
