...
Drag 'n Drop replace for indigo-garages.

- Delete indigo-garages.
- Drag the downloaded indigo-garages folder into the [qb] folder.
        ...
        options = {
            {
                type = "client",
                action = function ()
                    TriggerEvent('indigo-garages:client:ParkLastVehicle', garageName)
                end,
                icon = 'parking',
                label = 'Park Vehicle',
            },
...
* [JustLazzy](https://github.com/JustLazzy) - I used part of his indigo-garages script.
* [bamablood94](https://github.com/bamablood94) - I used part of his indigo-garages script.
