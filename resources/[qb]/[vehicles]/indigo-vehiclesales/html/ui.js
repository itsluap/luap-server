var app = new Vue({
    ...
    methods: {
        sell(sellPrice) {
            ...
            if (this.sellPrice != "") {
                if (!isNaN(sellPrice)) {
                    ...
                    fetch("https://indigo-vehiclesales/sellVehicle", requestOptions);
                    this.close();
                } else {
        ...
        buy() {
            ...
            fetch("https://indigo-vehiclesales/buyVehicle", requestOptions);
            this.close();
        },
        takeBack() {
            const requestOptions = {
            ...
            fetch("https://indigo-vehiclesales/takeVehicleBack", requestOptions);
            this.close();
        },
        close() {
            const requestOptions = {
            ...
            fetch("https://indigo-vehiclesales/close", requestOptions);
