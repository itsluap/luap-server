...
RegisterServerEvent("indigo-stancer:server:removestancer", function() 
...
QBCore.Functions.CreateUseableItem("stancerkit", function(source, item)   
  ...
  if Player.Functions.GetItemBySlot(item.slot) ~= nil then 
    TriggerClientEvent("indigo-stancer:addstancerkit", source) 
...
AddEventHandler("indigo-stancer:airsuspension", function(entity,val,coords)
	TriggerClientEvent("indigo-stancer:airsuspension", -1, entity,val,coords)
end)
