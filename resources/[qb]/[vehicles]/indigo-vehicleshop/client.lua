...
AddEventHandler('QBCore:Client:OnPlayerLoaded', function()
    ...
    TriggerServerEvent('indigo-vehicleshop:server:addPlayer', citizenid, gameTime)
    TriggerServerEvent('indigo-vehicleshop:server:checkFinance')
...
RegisterNetEvent('QBCore:Client:OnPlayerUnload', function()
    local citizenid = PlayerData.citizenid
    TriggerServerEvent('indigo-vehicleshop:server:removePlayer', citizenid)
    PlayerData = {}
end)
...
local vehHeaderMenu = {
    {
        ...
        params = {
            event = 'indigo-vehicleshop:client:showVehOptions'
        }
    }
}
...
local financeMenu = {
    {
        ...
        params = {
            event = 'indigo-vehicleshop:client:getVehicles'
        }
    }
}
...
local returnTestDrive = {
    {
        ...
        params = {
            event = 'indigo-vehicleshop:client:TestDriveReturn'
        }
    }
}
        ...
        while inTestDrive do
            if GetGameTimer() < gameTimer + tonumber(1000 * testDriveTime) then
                ...
                if secondsLeft >= tonumber(1000 * testDriveTime) - 20 then
                    TriggerServerEvent('indigo-vehicleshop:server:deleteVehicle', testDriveVeh)
                    testDriveVeh = 0
                    inTestDrive = false
                ...
                while insideShop do
                    ...
                    vehicleMenu = {
                        ...
                        },
                        {
                            ...
                            params = {
                                event = 'indigo-vehicleshop:client:TestDrive',
                            }
                        },
                        {
                            ...
                            params = {
                                isServer = true,
                                event = 'indigo-vehicleshop:server:buyShowroomVehicle',
                                args = {
                        ...
                        },
                        {
                            ...
                            params = {
                                event = 'indigo-vehicleshop:client:openFinance',
                                args = {
                                    price = getVehPrice(),
                                    buyVehicle = Config.Shops[insideShop]["ShowroomVehicles"][ClosestVehicle].chosenVehicle
                                }
                        ...
                        },
                        {
                            ...
                            params = {
                                event = 'indigo-vehicleshop:client:vehCategories',
                            }
                        },
                    }
                    Wait(1000)
                ...
                while insideShop and PlayerData.job and PlayerData.job.name == Config.Shops[name]['Job'] do
                    ...
                    vehicleMenu = {
                        ...
                        },
                        {
                            ...
                            params = {
                                event = 'indigo-vehicleshop:client:openIdMenu',
                                args = {
                        ...
                        },
                        {
                            ...
                            icon = "fa-solid fa-coins",
                            params = {
                                event = 'indigo-vehicleshop:client:openCustomFinance',
                                args = {
                                    price = getVehPrice(),
                                    vehicle = Config.Shops[insideShop]["ShowroomVehicles"][ClosestVehicle].chosenVehicle
                                }
...
-- Events
RegisterNetEvent('indigo-vehicleshop:client:homeMenu', function()
    exports['indigo-menu']:openMenu(vehicleMenu)
end)

RegisterNetEvent('indigo-vehicleshop:client:showVehOptions', function()
    exports['indigo-menu']:openMenu(vehicleMenu)
end)

RegisterNetEvent('indigo-vehicleshop:client:TestDrive', function()
...
RegisterNetEvent('indigo-vehicleshop:client:customTestDrive', function(data)
...
RegisterNetEvent('indigo-vehicleshop:client:TestDriveReturn', function()
...
RegisterNetEvent('indigo-vehicleshop:client:vehCategories', function()
    local categoryMenu = {
        {
            header = Lang:t('menus.goback_header'),
            icon = "fa-solid fa-angle-left",
            params = {
                event = 'indigo-vehicleshop:client:homeMenu'
            }
        }
    }
    for k, v in pairs(Config.Shops[insideShop]['Categories']) do
        categoryMenu[#categoryMenu + 1] = {
            ...
            params = {
                event = 'indigo-vehicleshop:client:openVehCats',
                args = {
                    catName = k
                }
            }
...
RegisterNetEvent('indigo-vehicleshop:client:openVehCats', function(data)
    local vehMenu = {
        {
            header = Lang:t('menus.goback_header'),
            icon = "fa-solid fa-angle-left",
                ...
                for _, shop in pairs(QBCore.Shared.Vehicles[k]["shop"]) do
                    if shop == insideShop then
                        vehMenu[#vehMenu + 1] = {
                            ...
                            params = {
                                isServer = true,
                                event = 'indigo-vehicleshop:server:swapVehicle',
                                args = {
                                    toVehicle = v.model,
...
RegisterNetEvent('indigo-vehicleshop:client:openFinance', function(data)
    ...
    if dialog then
        ...
        TriggerServerEvent('indigo-vehicleshop:server:financeVehicle', dialog.downPayment, dialog.paymentAmount, data.buyVehicle)
    end
end)
...
RegisterNetEvent('indigo-vehicleshop:client:openCustomFinance', function(data)
    ...
    if dialog then
        ...
        TriggerServerEvent('indigo-vehicleshop:server:sellfinanceVehicle', dialog.downPayment, dialog.paymentAmount, data.vehicle, dialog.playerid)
    end
end)

RegisterNetEvent('indigo-vehicleshop:client:swapVehicle', function(data)
...
RegisterNetEvent('indigo-vehicleshop:client:buyShowroomVehicle', function(vehicle, plate)
    tempShop = insideShop -- temp hacky way of setting the shop because it changes after the callback has returned since you are outside the zone
    QBCore.Functions.TriggerCallback('QBCore:Server:SpawnVehicle', function(netId)
        local veh = NetToVeh(netId)
        exports['ps-fuel']:SetFuel(veh, 100)
...
RegisterNetEvent('indigo-vehicleshop:client:getVehicles', function()
    QBCore.Functions.TriggerCallback('indigo-vehicleshop:server:getVehicles', function(vehicles)
        local ownedVehicles = {}
        for _, v in pairs(vehicles) do
            if v.balance ~= 0 then
                ...
                ownedVehicles[#ownedVehicles + 1] = {
                    ...
                    icon = "fa-solid fa-car-side",
                    params = {
                        event = 'indigo-vehicleshop:client:getVehicleFinance',
                        args = {
                            vehiclePlate = plate,
                            balance = v.balance,
...
RegisterNetEvent('indigo-vehicleshop:client:getVehicleFinance', function(data)
    local vehFinance = {
        {
            header = Lang:t('menus.goback_header'),
            params = {
        ...
        },
        {
            ...
            icon = "fa-solid fa-hand-holding-dollar",
            params = {
                event = 'indigo-vehicleshop:client:financePayment',
                args = {
                    vehData = data,
        ...
        },
        {
            ...
            params = {
                isServer = true,
                event = 'indigo-vehicleshop:server:financePaymentFull',
                args = {
...
RegisterNetEvent('indigo-vehicleshop:client:financePayment', function(data)
    ...
    if dialog then
        ...
        TriggerServerEvent('indigo-vehicleshop:server:financePayment', dialog.paymentAmount, data.vehData)
    end
end)
...
RegisterNetEvent('indigo-vehicleshop:client:openIdMenu', function(data)
    ...
    if dialog then
        ...
        if data.type == 'testDrive' then
            TriggerServerEvent('indigo-vehicleshop:server:customTestDrive', data.vehicle, dialog.playerid)
        elseif data.type == 'sellVehicle' then
            TriggerServerEvent('indigo-vehicleshop:server:sellShowroomVehicle', data.vehicle, dialog.playerid)
        end
    end
end)
