...
RegisterNetEvent('QBCore:Client:OnPlayerLoaded', function()
    disable = false
    TriggerServerEvent('indigo-weathersync:server:RequestStateSync')
end)

RegisterNetEvent('indigo-weathersync:client:EnableSync', function()
    disable = false
    TriggerServerEvent('indigo-weathersync:server:RequestStateSync')
end)

RegisterNetEvent('indigo-weathersync:client:DisableSync', function()
	disable = true
...
RegisterNetEvent('indigo-weathersync:client:SyncWeather', function(NewWeather, newblackout)
    CurrentWeather = NewWeather
    blackout = newblackout
end)

RegisterNetEvent('indigo-weathersync:client:SyncTime', function(base, offset, freeze)
    freezeTime = freeze
    timeOffset = offset
    baseTime = base
end)
