...
Config.Disable = {
    disableHudComponents = {1, 2, 3, 4, 6, 8, 7, 9, 13, 14, 19, 20, 21, 22}, -- Hud Components: https://docs.fivem.net/natives/?_0x6806C51AD12B83B8 -- 14 is crosshair
...
Config.Teleports = {
    ...
    [4] = {
        [1] = {
            ...
            ["AllowVehicle"] = false,
            drawText = '[E] Elevator to Investment Office'
        },
        [2] = {
            coords = vector4(-75.63, -827.06, 243.39, 60.16),
            ["AllowVehicle"] = false,
