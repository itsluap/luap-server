...
RegisterNetEvent('consumables:client:Eat', function(itemName, PropName)
    ...
    --TriggerEvent('ps-inventory:client:set:busy', true)
    exports['indigo-assets']:RequestAnimationDict("mp_player_inteat@burger")
    ...
    QBCore.Functions.Progressbar("eat", "Eating..", 7000, false, true, {
        ...
        disableCombat = true,
            ...
            --TriggerEvent('ps-inventory:client:set:busy', false)
...
RegisterNetEvent('consumables:client:Drink', function(itemName, PropName)
    exports['indigo-assets']:AddProp(PropName)
    --TriggerEvent('ps-inventory:client:set:busy', true)
    exports['indigo-assets']:RequestAnimationDict("amb@world_human_drinking@coffee@male@idle_a")
...
RegisterNetEvent('consumables:client:Cokebaggy', function()
    local ped = PlayerPedId()
    exports['indigo-assets']:AddProp('CrackPipe')
    ...
    exports['ps-buffs']:SwimmingBuffEffect(90000, 1.4)
end)
...
RegisterNetEvent('consumables:client:Crackbaggy', function()
    ...
    exports['ps-buffs']:StaminaBuffEffect(45000, 1.2)
    exports['ps-buffs']:SwimmingBuffEffect(45000, 1.2)
    exports['ps-buffs']:AddStressBuff(30000, 10)
    exports['ps-buffs']:AddHealthBuff(15000, 10)
end)
...
RegisterNetEvent('consumables:client:oxy', function()
    ...
    exports['ps-buffs']:AddStressBuff(120000, 10)
...
RegisterNetEvent('consumables:client:meth', function()
    ...
    exports['ps-buffs']:AddArmorBuff(90000, 5)
    exports['ps-buffs']:AddHealthBuff(90000, 5)
    exports['ps-buffs']:AddStressBuff(45000, 10)
end)
