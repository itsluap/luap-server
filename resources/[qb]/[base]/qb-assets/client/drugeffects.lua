...
RegisterNetEvent('effect:alien', function()
    AlienEffect()
end)
...
RegisterNetEvent('effect:lsd', function()
    Effectlsd()
end)
...
RegisterNetEvent('effect:meth', function()
    MethBagEffect()
end)
...
RegisterNetEvent('effect:trevor', function()
    TrevorEffect()
end)
...
RegisterNetEvent('effect:crack', function()
    CrackBaggyEffect()
end)
...
RegisterNetEvent('effect:ecstasy', function()
    EcstasyEffect()
end)
