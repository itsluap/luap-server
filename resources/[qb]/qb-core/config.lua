...
QBConfig.Money = {}
QBConfig.Money.MoneyTypes = { cash = 2500, bank = 97000, crypto = 0 } -- type = startamount - Add or remove money types for your server (for ex. blackmoney = 0), remember once added it will not be removed from the database!
