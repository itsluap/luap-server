...
QBConfig.Money = {}
QBConfig.Money.MoneyTypes = { cash = 2500, bank = 60000, crypto = 0 } -- type = startamount - Add or remove money types for your server (for ex. blackmoney = 0), remember once added it will not be removed from the database!
QBConfig.Money.DontAllowMinus = { 'cash', 'bank', 'crypto' } -- Money that is not allowed going in minus
QBConfig.Money.PayCheckTimeOut = 2 -- The time in minutes that it will give the paycheck
...
QBConfig.Server.Discord = "discord.gg/indigoroleplay" -- Discord invite link
QBConfig.Server.CheckDuplicateLicense = true -- Check for duplicate rockstar license on join
QBConfig.Server.Permissions = { 'god', 'admin', 'mod', 'dev' } -- Add as many groups as you want here after creating them in your server.cfg
