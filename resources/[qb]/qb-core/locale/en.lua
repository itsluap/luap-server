local Translations = {
    error = {
        ...
        duplicate_license           = '[INDIGO] - Duplicate Rockstar License Found',
        no_valid_license            = '[INDIGO] - No Valid Rockstar License Found',
        not_whitelisted             = '[INDIGO] - You\'re not whitelisted for this server',
        ...
        connecting_database_error   = '[INDIGO] - A database error occurred while connecting to the server. (Is the SQL server on?)',
        connecting_database_timeout = '[INDIGO] - Connection to database timed out. (Is the SQL server on?)',
    },
    success = {
