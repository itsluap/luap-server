...
data_file 'AUDIO_GAMEDATA' 'audioconfig/rb20det_game.dat'
data_file 'AUDIO_SOUNDDATA' 'audioconfig/rb20det_sounds.dat'
data_file 'AUDIO_WAVEPACK' 'sfx/dlc_rb20det'
...
-- Alfa Romeo Giulia GTAM Quadrifoglio 690T 2.9 V6 Engine 2.9 V6 Engine =  alfa690t
...
-- Aston Martin AM11 5.9 V12 Engine =  aston59v12 
...
-- Audi R8 5.2 V10 Engine =   lambov10
...
-- BMW M3 E46 S54 Inline-6 Engine =   s54b32
...
-- BMW M3 E92 S65 V8 Engine =  s65b40
...
-- BMW M5 / M8 S63 V8 Engine =  s63b44
...
-- BMW M5 E60 / M6 E64 S85 V10 Engine =   s85b50
...
-- Dodge Charger SRT / Trackhawk SRT ==     chargertrackhawkhemiv8
...
-- Dodge Charger 6.4 + 6.2SC V8 Engine Sound v1.1 =  npolchar
...
-- Dodge Ram Cummins 5.9 ISB I6 Engine =  cummins5924v
...
-- Ford Crown Victoria 4.6 Modular V8 Engine =   cvpiv8
...
-- Ford Explorer+Taurus PI 3.5 Ecoboost V6 Engine  =  ecoboostv6
...
-- Ford F-150 5.0 Coyote V8 Engine =  aq02coyotef150
...
-- GM Racing LS V8 Engine =   aqls7raceswap 
...
-- Honda B16A I4 Engine =   aq21honb16a
...
-- Honda B18C Type R I4 Engine =  aq22honb18c
...
-- Honda S2000 F20C/F22C VTEC Inline-4 Engine =   f20c
...
-- Mercedes-AMG SL65 M275 V12 Engine =  aqm275amg
...
-- Mitsubishi 4G63T I4 Engine Sound =  n4g63t
...
-- AMG Mitsubishi Lancer 4B11T I4 Engine =  aq26mit4b11t
...
-- Nissan Skyline HKS RB28DETT Stroker I6 Engine =   rb28dett
...
-- Nissan GT-R VR38DETT V6 Engine =  aq10nisvr38dett
...
-- Nissan VQ37VHR Turbo Engine =  aq14nisvq37vhrt
...
-- Porsche 718 Flat 4 Engine =  porschema2 
...
-- Porsche 4.0L Flat-6 Turbo Engine =   pgt3f6
...
-- Porsche Carrera GT 5.7 V10 Engine =   porsche57v10
...
-- Toyota JZA80 Engine STOCK =   aqtoy2jzstock
...
-- Toyota JZA80 Engine RACE version =  aq2jzgterace
...
-- Subaru STI EJ257 F4 Engine STOCK =  aq03ej257
...
-- Subaru STI EJ257 F4 RACE Engine =   aq05ej257el
...
-- Volkswagen-Audi RS6 EA825 V8 Engine =  ea825
...
-- Volkswagen-Audi Golf GTI 7 EA888 DSG I4 Engine =  ea888
...
-- Kawasaki H2R Ninja =   ta103ninjah2r
...
-- Lexus F-500 )Toyota 2UR-GSE) =   ta007toy2ur
...
-- Ferrari Enzo F140B =   ta018ferf140b
...
-- Ford Mustang GT 5.0L = tamustanggt50
...
-- Ford Mustang GT SC 5.0L = tascmustanggt50
...
-- Lamborghini Aventador (L539 V12) =   ta023l539  
...
-- Ferrari 488-F8-SF90 F154 = ta488f154  
...
-- LaFerrari Ferrari F140FE =   ferrarif140fe
...
-- KTM 1290 Super Duke R =  ktm1290r
...
-- Dodge Charger Cammed HEMI V8 =  cammedcharger 
...
-- Ford Shelby GT350R Voodoo =  fordvoodoo
...
-- Audi 5 Cylinder EA855 =  audiea855
...
-- Mercedes V8 M-113 =  mercedesm113
...
-- Mercedes V8 M-155 =  mercedesm155
...
-- Volkswagen Flat 4 Beetle? = vwflat4
