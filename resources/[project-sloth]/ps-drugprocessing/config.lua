...
Config.CircleZones = {
	...
	SodiumHydroxideFarm = {coords = vector3(-140.46, -2223.77, 7.81), name = ('Sodium Hydroxide'), radius = 100.0},
	...
	CokeField = {coords = vector3(2016.82, 4887.32, 42.7), name = ('Coke'), radius = 100.0},
